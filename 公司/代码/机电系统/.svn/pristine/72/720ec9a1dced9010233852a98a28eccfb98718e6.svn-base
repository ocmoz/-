...
public partial class Module_FM2E_MaintainManager_MaintainManager_MaintainSheet_MaintainSheetList : System.Web.UI.Page
{
    ...
    private void InitPage()
    {
        ...
        DropDownList_ConfirmResult.Items.AddRange(EnumHelper.GetListItems(typeof(MaintainConfirmResult)));
    ...
    protected void Repeater_MaintainSheet_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "ViewCMD":
                {
                    //转向查看页面
                    Response.Redirect("ViewMaintainSheet.aspx?cmd=view&id=" + id);
                    break;
                }
