...
public partial class Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolRecordVerify_DailyPatrolRecordList : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (bSuccess)
        {
            EventMessage.MessageBox(Msg_Type.Info, "操作成功", "审核成功", Icon_Type.OK, true, Common.GetHomeBaseUrl("DailyPatrolRecordList.aspx"), UrlType.Href, "");
        }
    }
}
