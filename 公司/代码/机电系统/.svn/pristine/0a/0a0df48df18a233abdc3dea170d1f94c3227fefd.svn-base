<%@ Page Title="备品备件验收" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="Check.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_CheckInWarehouse_Check" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件验收"
        HeadOPTxt="目前操作功能：验收">
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="报验" ButtonUrlType="Href"
            ButtonUrl="SendWarehouse.aspx" ButtonPopedom="New" />
        <cc1:HeadMenuButtonItem ButtonIcon="select.gif" ButtonName="验收历史" ButtonUrlType="Href"
            ButtonUrl="CheckHistory.aspx" ButtonPopedom="List" />
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle">
                    <asp:Label ID="Label_WarehouseName" runat="server" ForeColor="Blue" Font-Bold="true"></asp:Label>
                    正在采购或者等待验收的采购单
                </td>
            </tr>
            <tr>
                                ...
                                <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="申购单">
                                            <ItemTemplate>
                                                <a style="color: Blue" href='CheckPurchaseOrder.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
                                ...
                                <asp:GridView ID="gridview_check" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="报验单">
                                            <ItemTemplate>
                                                <a style="color: Blue" href='CheckCAForm.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
