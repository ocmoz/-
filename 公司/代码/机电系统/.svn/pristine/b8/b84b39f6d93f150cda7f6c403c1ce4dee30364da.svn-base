<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ViewConsumableEquipment.aspx.cs" Inherits="Module_FM2E_DeviceManager_DeviceInfo_ConsumableEquipmentManager_ViewConsumableEquipment" %>
