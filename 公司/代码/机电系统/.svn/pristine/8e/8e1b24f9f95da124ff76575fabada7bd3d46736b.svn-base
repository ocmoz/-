<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage/MasterPage.master" CodeFile="Impotwarehouse.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_InWarehouse_Impotwarehouse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件信息维护"
        HeadOPTxt="目前操作功能：备品备件信息维护">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="备品备件列表" ButtonPopedom="List"
