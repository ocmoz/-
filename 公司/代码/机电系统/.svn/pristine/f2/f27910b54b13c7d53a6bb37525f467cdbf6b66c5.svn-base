...
{
    public class RoutineMaintainWorkflow: StateMachineWorkflowActivity
    {
        public RoutineMaintainWorkflow()
            : base()
        {
        }
        ...
        static public String WorkflowName
        {
            get
            {
                return "RoutineMaintainWorkflow";
            }
        }
        static public String TableName
        {
            get
            {
                return "FM2E_RoutineMaintainPlan";
            }
        }
