<%@ Page Title="查看采购单" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalViewPurchaseOrder.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseApproval_ApprovalViewPurchaseOrder" %>
 ...
 <script type="text/javascript" src="<%=Page.ResolveUrl("~/") %>inc/FineMessBox/js/common.js"></script>
    ...
    <script type="text/javascript">
     //审批一个材料
        ...
        function setAgree() {
            document.getElementById('<%= TextBox_ApprovalRemark.ClientID %>').value += " 同意采购 ";
        }
    </script>
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件采购"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回列表" ButtonUrlType="Href" ButtonPopedom="List"
            ButtonUrl="PurchaseApproval.aspx" />
    ...
    <div id="div_table">
        <table id="RootTable" style="width: 98%; border-collapse: collapse; vertical-align: middle;
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="数量<br/>申请/审批">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="Label_PlanCount" runat="server" 
                                                ...
                                                Text='<%# Eval("AdjustCount", "{0:#,0.##}") %>'></asp:Label>
                                                
                                                 <a id="querystorage" runat="server" 
                                    ...
                                    <asp:TemplateField HeaderText="单价(元)<br/>申请/审批">
                                        <ItemTemplate>
                                           ...
                                           href='<%# string.Format(Eval("ProductQueryPriceScript").ToString(),CanAdjust) %>'><span style="color:Blue">查询指导价</span>
                                           </a>
                                        </ItemTemplate>
                                        <ItemStyle Width="10%" />
                                    </asp:TemplateField>
            ...
            <tr>
                 ...
                 <asp:Button ID="Button_GetApproval" runat="server" Text="我要审批" 
                        CssClass="button_bak" onclick="Button_GetApproval_Click" />
                 <asp:Button ID="Button_ReleaseApproval" runat="server" Text="放弃审批"  OnClientClick="javascript:return confirm('确认放弃审批？');"
          ...
          <table runat="server" id="Table_Approval" visible="false" style="width: 98%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                 ...
                 <td style="width:85%"> <a href="javascript:setAgree();" style="color:Blue">同意采购</a><br />
                     <asp:TextBox ID="TextBox_ApprovalRemark" runat="server" TextMode="MultiLine" 
                         Width="600px" Height="200px"></asp:TextBox><span style="color:Red; font-weight:bold">&nbsp;*&nbsp;</span></td>
            </tr>
             <tr>
                <td class="Table_searchtitle"  colspan="2">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="申购单">
                                <ItemTemplate>
                                    ...
                                    <asp:Label Text='<%# Eval("PurchaseOrderID") %>' runat="server" ID="Label_OrderID"></asp:Label>-<asp:Label Text='<%# Eval("SubOrderIndex")%>' runat="server"
