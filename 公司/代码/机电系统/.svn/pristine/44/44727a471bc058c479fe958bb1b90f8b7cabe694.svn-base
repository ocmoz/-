...
public partial class Module_FM2E_ArchivesManager_ArchivesBorrowApply_ArchivesBorrowApproval_ArchivesBorrowApply : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            List<string> states = WorkflowHelper.GetCorrelativeStateNameList(ArchivesBorrowWorkflow.WorkflowName, Common.Get_UserName);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ArchivesBorrowApplyApproval.aspx?cmd=approval&id=" + id);
        }
    }
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ArchivesBorrowApplyInfo item = (ArchivesBorrowApplyInfo)e.Row.DataItem;
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("../ArchivesBorrowApply/ViewArchivesBorrowApply.aspx?cmd=viewArchives&id=" + id);
        }
    }
