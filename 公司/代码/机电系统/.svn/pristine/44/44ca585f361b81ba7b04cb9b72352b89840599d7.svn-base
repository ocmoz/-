...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_CancelMalfunctionList : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //验收
            Response.Redirect("CancelMalfunctionSheet.aspx?cmd=view&id=" + id);
        }
