<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="DailyPatrolRecord.aspx.cs" Inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolRecord_DailyPatrolRecord"
    Title="Untitled Page" %>
