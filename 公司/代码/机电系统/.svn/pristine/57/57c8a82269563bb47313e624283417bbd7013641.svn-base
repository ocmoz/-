...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionMaintain_InteriorMalfunctionList : System.Web.UI.Page
{
    ...
    private MalfunctionSearchInfo SearchTerm
    {
        get
        {
            if (ViewState["SearchTerm"] == null)
            {
                ...
                term.MaintainDept = 10;
                term.Recorder = UserData.CurrentUserData.UserName;
    ...
    private void InitialPage()
    {
        ...
        //if (deptInfo == null || deptInfo.DepartmentType == DepartmentType.Unknown)
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //查看
            Response.Redirect("MalfunctionHandle.aspx?cmd=edit&from=1&id=" + id);
        }
    }
    /// <summary>
    /// GridView数据绑定事件
