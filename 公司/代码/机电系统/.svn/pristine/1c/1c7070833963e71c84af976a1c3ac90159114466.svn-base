<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ViewBugreport.aspx.cs" Inherits="Module_FM2E_BugReportManager_ViewBugreport_ViewBugreport" %>
