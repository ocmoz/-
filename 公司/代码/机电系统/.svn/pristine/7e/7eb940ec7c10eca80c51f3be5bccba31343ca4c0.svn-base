...
public partial class Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_SelectDevice : System.Web.UI.Page
{
    ...
    private void ButtonBind()
    {
        ...
        button.ButtonUrl = string.Format("ViewRoutineInspectConfig.aspx?cmd=view&id={0}", id);
    }
