...
public partial class Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectView_RoutineInspectTrack : System.Web.UI.Page
{
    ...
    protected void btnReport1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            reportdocument.Load(Server.MapPath("~") + "/report/RoutineInspect/RoutineInspectGrahpReport.rpt");
                ...
                case MaintainPlanPeriodUnit.Year:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineInspect/RoutineInspectListReport1.rpt");
                        break;
                    }
                case MaintainPlanPeriodUnit.Season:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineInspect/RoutineInspectListReport2.rpt");
                        break;
                    }
                case MaintainPlanPeriodUnit.Month:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineInspect/RoutineInspectReport3.rpt");
                        break;
                    }
                ...
                case MaintainPlanPeriodUnit.Day:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineInspect/RoutineInspectListReport4.rpt");
                        break;
                    }
            }
