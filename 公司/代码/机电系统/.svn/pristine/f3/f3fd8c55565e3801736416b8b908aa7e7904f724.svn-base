...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionMaintain_InteriorMalfunctionSheets : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "record")
        {
            ...
            {
                Response.Redirect("MalfunctionHandleFinished.aspx?cmd=edit&from=2&&id=" + id);
            }
        }
