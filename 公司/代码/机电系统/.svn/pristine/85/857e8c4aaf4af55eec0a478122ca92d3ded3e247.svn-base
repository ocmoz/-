...
{
    public enum RoutineMaintainPlanStatus
    {
        /// <summary>
        /// 未知状态
        /// </summary>
    ...
    public class RoutineMaintainPlanInfo
    {
        /// <summary>
        /// 例行保养计划状态
        /// </summary>
        ...
        private RoutineMaintainPlanStatus _status;
        ...
        /// 
        /// </summary>
        public RoutineMaintainPlanStatus Status
        {
            set { _status = value; }
            get { return _status; }
        }
        ...
        public string StatusString
        {
            get
            {
                ...
                switch (_status)
                {
                    case RoutineMaintainPlanStatus.Draft:
                        statusString = "草稿";
                        break;
                    case RoutineMaintainPlanStatus.Waiting4ApprovalResult:
                        statusString = "等待审批结果";
                        break;
                    case RoutineMaintainPlanStatus.ApprovalPassed:
                        statusString = "正式执行";
                        break;
                    case RoutineMaintainPlanStatus.ApprovalFailed:
                        statusString = "审批不通过";
                        break;
                    case RoutineMaintainPlanStatus.PlanComplete:
                        statusString = "执行完毕";
                        break;
                    default:
                        statusString = "未知状态";
