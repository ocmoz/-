...
{
    public enum RoutineInspectPlanStatus
    {
        /// <summary>
        /// 未知状态
        /// </summary>
    ...
    public class RoutineInspectPlanInfo
    {
        /// <summary>
        /// 例行检测计划状态
        /// </summary>
        ...
        private RoutineInspectPlanStatus _status;
        ...
        /// 
        /// </summary>
        public RoutineInspectPlanStatus Status
        {
            set { _status = value; }
            get { return _status; }
        }
        ...
        public string StatusString
        {
            get
            {
                ...
                switch (_status)
                {
                    case RoutineInspectPlanStatus.Draft:
                        statusString = "草稿";
                        break;
                    case RoutineInspectPlanStatus.Waiting4ApprovalResult:
                        statusString = "等待审批结果";
                        break;
                    case RoutineInspectPlanStatus.ApprovalPassed:
                        statusString = "正式执行";
                        break;
                    case RoutineInspectPlanStatus.ApprovalFailed:
                        statusString = "审批不通过";
                        break;
                    case RoutineInspectPlanStatus.PlanComplete:
                        statusString = "执行完毕";
                        break;
                    default:
                        statusString = "未知状态";
