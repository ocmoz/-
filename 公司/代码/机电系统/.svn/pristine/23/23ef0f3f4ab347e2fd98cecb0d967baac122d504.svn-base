<%@ Page MasterPageFile="~/MasterPage/MasterPage.master" Language="C#" AutoEventWireup="true"
    CodeFile="PriceApply.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_PriceManager_PriceMaintenance_PriceApply" %>
