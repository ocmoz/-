<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="EquipmentStatics.aspx.cs" Inherits="Module_FM2E_DeviceManager_UsedEquipmentManager_EquipmentStatics_EquipmentStatics"
    Title="Untitled Page" %>
