...
public partial class Module_FM2E_BudgetManagement_QuarterlyBudget_QuarterlyBudget : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "view")
        {
            ...
            Response.Redirect("ViewQuarterlyBudget.aspx?cmd=view&id=" + TotalID);
        }
        if (e.CommandName == "del")
        {
            ...
            if(budgetpermonthtotalinfo == null)
                EventMessage.MessageBox(Msg_Type.Error, "操作失败", "本季度预算已被删除！", new WebException("本季度预算已被删除！"), Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
