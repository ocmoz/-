...
public partial class Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_RoutineInspectConfig : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ViewRoutineInspectConfig.aspx?cmd=view&id=" + id);
        }
