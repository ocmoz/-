...
public partial class Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyApproval_ArchivesDestroyApply : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ArchivesDestroyApplyApproval.aspx?cmd=approval&id=" + id);
        }
    }
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("../ArchivesDestroyApply/ViewArchivesDestroyApply.aspx?cmd=viewArchives&id=" + id);
        }
    }
