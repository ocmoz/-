<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="WarehouseInventory.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_WarehouseInventory_WarehouseInventory"
    Title="Untitled Page" %>
