...
EnableEventValidation="false" CodeFile="ViewRoutineInspectConfig.aspx.cs" Inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_ViewRoutineInspectConfig" Title="无标题页" %>
