...
namespace FM2E.Model.BudgetManagement
{
    [Serializable]
    public class QuarterlyForecastDetailInfo
    {
        #region Model
        ...
        public static QuarterlyForecastDetailInfo CloneObject(QuarterlyForecastDetailInfo obj)
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                stream.Position = 0;
                return (QuarterlyForecastDetailInfo)formatter.Deserialize(stream);
            }
        }
