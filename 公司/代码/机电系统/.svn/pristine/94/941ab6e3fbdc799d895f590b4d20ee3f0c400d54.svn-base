<%@ Page Title="执行采购" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="ExecutePurchasingHistory.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_ExecutePurchasing_ExecutePurchasingHistory" %>
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                    <span style="color:Blue; font-weight:bold"> <%= WebUtility.UserData.CurrentUserData.PersonName %>(<%= WebUtility.UserData.CurrentUserData.UserName %>)</span>&nbsp;处理过的采购单
                </td>
            </tr>
            <tr>
                                    ...
                                    <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="申购单">
                                                <ItemTemplate>
                                                    <a style="color: Blue" href='ViewPurchaseOrderHistory.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
                                           ...
                                           <asp:BoundField DataField="WorkFlowStateDescription" HeaderText="状态">
                                            ...
                                            <asp:TemplateField HeaderText="申请人">
                                                <ItemTemplate>
                                                   <asp:Label ID="Label_ApplicantName" runat="server" Text='<%# Eval("ApplicantName") %>'></asp:Label>                                                 </ItemTemplate>
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                     ...
                     <span style="color: Blue; font-weight: bold">
                        <%= WebUtility.UserData.CurrentUserData.PersonName %>(<%= WebUtility.UserData.CurrentUserData.UserName %>)</span>核实过的报验单
                </td>
            </tr>
            <tr>
                <td class="table_none_NoWidth">
