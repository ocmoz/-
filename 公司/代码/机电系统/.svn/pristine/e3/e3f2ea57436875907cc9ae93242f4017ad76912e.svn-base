<%@ Page Title="申购单审批列表" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="PurchaseApproval.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseApproval_PurchaseApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="申购单审批"
        HeadOPTxt="目前操作功能：申购单审批列表">
        <cc1:HeadMenuButtonItem ButtonIcon="select.gif" ButtonName="审批历史" ButtonUrlType="Href"
            ButtonUrl="PurchaseApprovalHistory.aspx" ButtonPopedom="List" />
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                    <span style="color:Blue; font-weight:bold"> <%= WebUtility.UserData.CurrentUserData.PersonName %>(<%= WebUtility.UserData.CurrentUserData.UserName %>)</span>&nbsp;正在处理以及待审批的申购单
                </td>
            </tr>
            <tr>
                                    ...
                                    <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="申购单">
                                                <ItemTemplate>
                                                    <a style="color: Blue" href='ApprovalViewPurchaseOrder.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
