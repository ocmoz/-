...
public partial class Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectRecordVerify_RoutineInspectList : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (bSuccess)
        {
            EventMessage.MessageBox(Msg_Type.Info, "操作成功", "审核成功", Icon_Type.OK, true, Common.GetHomeBaseUrl("RoutineInspectList.aspx"), UrlType.Href, "");
        }
    }
}
