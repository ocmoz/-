<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="EditEquipmentExpendable.aspx.cs" 
Inherits="Module_FM2E_DeviceManager_DeviceInfo_WareConsumableEquipmentManager_EditEquipmentExpendable" %>
