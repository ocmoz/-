<%@ Page Title="工程验收" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="CheckAccept.aspx.cs" Inherits="Module_FM2E_SpecialProject_ProjectFinish_CheckAccept" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程验收"
        HeadOPTxt="目前操作功能：工程验收" HeadHelpTxt="若施工计划并未全部完成，则不能进行完工验收">
    </cc1:HeadMenuWebControls>
    
    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
        <cc2:TabPanel runat="server" HeaderText="工程验收" ID="TabPanel0" Width="100%">
        ...
        <tr style="height: 30px">
            <th colspan="2" class="Table_searchtitle">
            专项工程验收<asp:Label ID="Label_FinishTip" runat="server"></asp:Label></th>
            </tr>
            <tr style="height: 30px">
                ...
                <td>
                    <div id="div_complete" runat="server" visible="False">
                        完工备注：
                        <asp:TextBox ID="TextBox_CompleteRemark" runat="server"  Width="95%"></asp:TextBox>
                        <br />
                        <span >负责人：<asp:TextBox ID="TextBox_CompleteApprovaler" runat="server"></asp:TextBox></span>
                        <asp:Button ID="Button_SaveComplete" runat="server" Text="完工" 
                        onclick="Button_SaveComplete_Click" OnClientClick="javascript:return confirm('确认完工？确认后不能修改');"  CssClass="button_bak" />
                    </div>
            ...
            <tr style="height: 30px">
                ...
                <td>
                    <div id="div_pass" runat="server"  visible="False">
                        交工备注：
                        <asp:TextBox ID="TextBox_PassRemark" runat="server" Width="95%"></asp:TextBox>
                        <br />
                        <span >负责人：<asp:TextBox ID="TextBox_PassApprovaler" runat="server"></asp:TextBox></span>
                          <asp:Button ID="Button_SavePass" runat="server" Text="交工" 
                            onclick="Button_SavePass_Click"  OnClientClick="javascript:return confirm('确认交工？确认后不能修改');" CssClass="button_bak"  />
                    </div>
            ...
            <tr style="height: 30px">
                ...
                <td>
                    <div id="div_finish" runat="server"  visible="False">
                        
                        竣工备注：
                        <asp:TextBox ID="TextBox_FinishRemark" runat="server" Width="95%"></asp:TextBox>
                        <br />
                        <span >负责人：<asp:TextBox ID="TextBox_FinishApprovaler" runat="server"></asp:TextBox></span>
                         <asp:Button ID="Button_SaveFinish" runat="server" Text="竣工" 
                            onclick="Button_SaveFinish_Click"   OnClientClick="javascript:return confirm('确认竣工？确认后不能修改');"  CssClass="button_bak" />
                    </div>
