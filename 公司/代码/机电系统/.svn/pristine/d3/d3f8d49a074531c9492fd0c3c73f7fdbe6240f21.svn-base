...
public partial class Module_FM2E_DeviceManager_DeviceInfo_CurrentEuipementInfo_AllEquipmentInfo_EditDevice : System.Web.UI.Page
{
    public string cmd = (string)Common.sink("cmd", MethodType.Get, 50, 0, DataType.Str);
    long id = (long)Common.sink("id", MethodType.Get, 64, 0, DataType.Long);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            FillData();
            ButtonBind();
            //FillDateForDailyPatrol();
            //FillDateForRoutineInspect();
            //FillDateForRoutineMaintain();
        }
        else
        {
        ...
        if (cmd == "edit"||(cmd=="add"&&action=="split"))
        {
            try
            {
                ...
                else
                {
                    ...
                    if (item.Status != 0)
                    Status.SelectedValue = ((int)item.Status).ToString();
                    ...
                    TextBox_AssertNumber.Text = item.AssertNumber;
                }
    ...
    private void ButtonBind()
    {
        ...
        button0.ButtonUrl += "?companyid=" + companyid+"&index="+index;
        if (cmd == "add")
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //  [4/24/2013 Tvk]
        Equipment bllEq= new Equipment();

        if (cmd == "add"&& bllEq.GetEquipmentBYNO(EquipmentNO.Text)!=null) 
        {
            EventMessage.MessageBox(Msg_Type.Error, "操作失败", "重复的条码", Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
        }
        ...
        if ("edit" == cmd || "add" == cmd)
        {
            ...
            if ("edit" == cmd)
            {
                ...
                if (bSuccess)
                {
                    EventMessage.MessageBox(Msg_Type.Info, "操作成功", string.Format("修改设备信息成功，条形码为{0}！",item.EquipmentNO), Icon_Type.OK, true, Common.GetHomeBaseUrl("DeviceInfo.aspx?index="+index), UrlType.Href, "");
                }
            }
            else if ("add" == cmd)
            {
                ...
                if (bSuccess)
                {
                    EventMessage.MessageBox(Msg_Type.Info, "操作成功", string.Format("添加设备信息成功，条形码为{0}！", item.EquipmentNO), Icon_Type.OK, true, Common.GetHomeBaseUrl("DeviceInfo.aspx?index="+index), UrlType.Href, "");
                }
    ...
    //    }
    //}
    //protected void FillDateForDailyPatrol()
    //{
    //    try
    //    {
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        //DailyPatrolConfig bll = new DailyPatrolConfig();
    //        IList list = bll.GetMaintainPlanConfigByEquipmentNO(Convert.ToString(ViewState["EquipmentNO"]), MaintainPlanType.DailyPatrol);
    //        GridView1.DataSource = list;
    //        GridView1.DataBind();
    //    }
    //    catch (Exception ex)
    //    {
    //        EventMessage.EventWriteLog(Msg_Type.Error, "获取日常巡查项目失败" + ex.Message);//, Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
    ...
    //            MaintainPlanConfig bll = new MaintainPlanConfig();
    //            bll.DelMaintainPlanEquipment(Convert.ToString(ViewState["EquipmentNO"]), id);
    //            FillDateForDailyPatrol();
    //        }
    //        catch (Exception ex)
    //        {
    ...
    //}
    //protected void btnAddDailyPatrol_Click(object sender, EventArgs e)
    //{
    //    try
    //    {
    //        if (DDLPatrolObject.SelectedValue == "")
    //        {
    //            return;
    //        }
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        bll.InsertMaintainPlanEquipment(Convert.ToString(ViewState["EquipmentNO"]), Convert.ToInt64(DDLPatrolObject.SelectedValue));
    //        FillDateForDailyPatrol();
    //    }
    //    catch (Exception ex)
    //    {
    //        EventMessage.MessageBox(Msg_Type.Error, "操作失败", "添加数据失败：" + ex.Message, Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
    //    }
    //}

    //protected void FillDateForRoutineMaintain()
    //{
    //    try
    //    {
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        //DailyPatrolConfig bll = new DailyPatrolConfig();
    //        IList list = bll.GetMaintainPlanConfigByEquipmentNO(Convert.ToString(ViewState["EquipmentNO"]), MaintainPlanType.RoutineMaintain);
    ...
    //}
    //protected void btnAddRoutineMaintain_Click(object sender, EventArgs e)
    //{
    //    try
    //    {
    //        if (DDLMaintainObject.SelectedValue == "")
    //        {
    //            return;
    //        }
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        bll.InsertMaintainPlanEquipment(Convert.ToString(ViewState["EquipmentNO"]), Convert.ToInt64(DDLMaintainObject.SelectedValue));
    //        FillDateForRoutineMaintain();
    //    }
    //    catch (Exception ex)
    //    {
    ...
    //protected void FillDateForRoutineInspect()
    //{
    //    try
    //    {
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        //DailyPatrolConfig bll = new DailyPatrolConfig();
    //        IList list = bll.GetMaintainPlanConfigByEquipmentNO(Convert.ToString(ViewState["EquipmentNO"]), MaintainPlanType.RoutineInspect);
    //        GridView3.DataSource = list;
    //        GridView3.DataBind();
    //    }
    //    catch (Exception ex)
    //    {
    //        EventMessage.EventWriteLog(Msg_Type.Error, "获取例行保养项目失败" + ex.Message);//, Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
    ...
    //}
    //protected void btnAddRoutineInspect_Click(object sender, EventArgs e)
    //{
    //    try
    //    {
    //        if (DDLInspectObject.SelectedValue == "")
    //        {
    //            return;
    //        }
    //        MaintainPlanConfig bll = new MaintainPlanConfig();
    //        bll.InsertMaintainPlanEquipment(Convert.ToString(ViewState["EquipmentNO"]), Convert.ToInt64(DDLInspectObject.SelectedValue));
    //        FillDateForRoutineInspect();
    //    }
    //    catch (Exception ex)
    //    {
