...
public partial class Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainRecord_RoutineMaintainRecord : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Button1.Text == "更新记录")
        {
            try
            {
                ...
                info.RecordmanID = TBRecordmanID.Text.Trim();
    ...
    private bool ValidateDetailInput()
    {
        ...
        if (TBRecordDate.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    errorMsg = "保养日期不能大于当前时间";
                }

            }
            catch
            {
                errorMsg = "保养日期只能为日期格式，请检查输入";
            }
        }
    ...
    {
        EventMessage.MessageBox(Msg_Type.Info, "操作成功", "执行例行保养成功！", Icon_Type.OK, true, Common.GetHomeBaseUrl("RoutineMaintainRecord.aspx"), UrlType.Href, "");
    }
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "view")  //编辑
        {
            ...
            TBRecordDate.Text = info.RecordDate.ToString();
            TBRecordmanID.Text = info.RecordmanID;
