<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageNoCheck.master"
    AutoEventWireup="true" CodeFile="CancelMalfunctionSheet.aspx.cs" Inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_CancelMalfunctionSheet" %>
