<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ExamineList.aspx.cs" Inherits="Module_FM2E_ExamineManager_ExamineConfirm_ExamineList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" Runat="Server">
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="考核表确认"
        HeadOPTxt="目前操作功能：待确认的考核表列表" HeadHelpTxt="默认显示待确认的考核表">
    ...
    <td class="table_body table_body_NoWidth"> <asp:Button ID="btSearch" runat="server" Text="查询" CssClass="button_bak" OnClick="btSearch_Click"/></td>
    </tr>
    </table>
        <asp:GridView ID="gvExamineSheets" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <%#EnumHelper.GetDescription((Enum)Eval("Status")) %>
                 ...
                 <asp:TemplateField>
                 <HeaderTemplate>确认</HeaderTemplate>
                <ItemStyle Width="60px" />
                <ItemTemplate>
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/ICON/Approval.gif"
                        CommandName="approval" CommandArgument='<%#Eval("ExamSheetID")%>' 
