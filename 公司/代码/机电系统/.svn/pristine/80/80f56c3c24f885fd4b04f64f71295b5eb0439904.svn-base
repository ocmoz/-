...
public partial class Module_FM2E_DeviceManager_DeviceInfo_WareConsumableEquipmentManager_EditEquipmentExpendable : System.Web.UI.Page
{
    ...
    private void InitialPage()
    {
        try
        {
            ...
            DDL_System.Items.Insert(0, new ListItem("请选择","0"));
            //仓库
    ...
    {
        if (DropDownList_FilterWareHouse.SelectedValue == "select")
        {
            Lable_Warehouse.Text = "请选择仓库！";
        }
        else
        {
            WarehouseInfo warehouse = (new Warehouse()).GetWarehouse(DropDownList_FilterWareHouse.SelectedValue);

            Lable_Warehouse.Text = "";
            ...
            item.CompanyID = warehouse.CompanyID;
            item.AddressCode = warehouse.AddressCode;
            item.AddressID = warehouse.AddressID;
            item.AddressName = warehouse.AddressName;
