<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="DailyPatrolConfig.aspx.cs" Inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolConfig_DailyPatrolConfig"
    Title="Untitled Page" %>
