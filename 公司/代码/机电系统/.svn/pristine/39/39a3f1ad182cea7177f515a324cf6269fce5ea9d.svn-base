<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="EditArchivesType.aspx.cs" Inherits="Module_FM2E_ArchivesManager_ArchivesTypeManage_EditArchivesType" %>
