<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Employee.aspx.cs" Inherits="Module_FM2E_Report_Input_Employee" %>
			...
			<div id="main-tablist">
				<div id="button-bar">
					<ul>
						<li>
							<input type="button" 
								onclick="javascript:jump('Yuangong_Yusuanzhixingqingkuang_i.raq','')"
