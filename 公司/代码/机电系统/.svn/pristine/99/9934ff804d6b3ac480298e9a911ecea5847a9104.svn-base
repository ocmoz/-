...
public partial class Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyApply_ViewArchivesDestroyApply : System.Web.UI.Page
{
    ...
    private void ButtonBind()
    {
        if (cmd == "view")
        {
            ...
            button.ButtonUrl = string.Format("EditArchivesDestroyApply.aspx?cmd=edit&id={0}", id);
        }
        ...
        else if (cmd == "delete")
        {
            ...
            if (bSuccess == true)
            {
                EventMessage.MessageBox(Msg_Type.Info, "操作成功", "删除申请成功！", Icon_Type.OK, true, Common.GetHomeBaseUrl("ArchivesDestroyApply.aspx"), UrlType.Href, "");
            }
        }
    }
    /// <summary>
