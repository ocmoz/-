...
{
    public class BudgetMonthlyEventService : IBudgetMonthlyEventService, IBasicEventService
    {
        ...
        public event EventHandler<ExternalDataEventArgs> DepartmentReturntoDraft
        {
            add
            {
                if(_eventList.ContainsValue(value) == false)
                    _eventList.Add("DepartmentReturntoDraft", value);
            }
            remove
            {
            }
        }
        public event EventHandler<ExternalDataEventArgs> SubmitDepartmentApproval
        {
            add
            {
                if(_eventList.ContainsValue(value) == false)
                    _eventList.Add("SubmitDepartmentApproval", value);
            }
            remove
            {
            }
        ...
        public event EventHandler<ExternalDataEventArgs> FinanceReturntoDepartment
        {
            add
            {
                if(_eventList.ContainsValue(value) == false)
                    _eventList.Add("FinanceReturntoDepartment", value);
            }
            remove
            {
            }
