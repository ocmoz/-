<%@ Page Title="设备入库" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="InWarehouse.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseInWarehouse_InWarehouse" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件入库"
        HeadOPTxt="目前操作功能：入库单列表" HeadHelpTxt="以下为本仓库等待入库的清单">

        <cc1:HeadMenuButtonItem ButtonIcon="select.gif" ButtonName="入库历史" ButtonUrlType="Href"
            ButtonUrl="InWarehouseHistory.aspx" ButtonPopedom="List" />
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle">
                  <asp:Label ID="Label_WarehouseName" ForeColor="Blue" runat="server" Font-Bold="true"></asp:Label>等待入库的采购单
                </td>
            </tr>
            <tr>
                                    ...
                                    <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="申购单">
                                                <ItemTemplate>
                                                    <a style="color: Blue" href='InWarehousePurchaseOrder.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
                                ...
                                <asp:GridView ID="gridview_check" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="报验单">
                                            <ItemTemplate>
                                                <a style="color: Blue" href='InCAForm.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
