...
public partial class Module_FM2E_BasicData_ContractorManage_Contractor : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        long id = Convert.ToInt64(gvRow.Attributes["ContractorID"]);
        if (e.CommandName == "view")
        {
            Response.Redirect("ViewContractor.aspx?cmd=view&id=" + id);
        }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ContractorInfo item = (ContractorInfo)e.Row.DataItem;
        e.Row.Attributes["ContractorID"] = item.ContractorID.ToString();
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        item.Service = Common.inSQL(TextBox2.Text.Trim());
