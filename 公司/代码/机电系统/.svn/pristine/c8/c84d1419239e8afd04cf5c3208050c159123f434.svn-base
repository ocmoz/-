...
EnableEventValidation="false" CodeFile="ExpendableRecord.aspx.cs" Inherits="Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_ExpendableRecord" Title="无标题页" %>
