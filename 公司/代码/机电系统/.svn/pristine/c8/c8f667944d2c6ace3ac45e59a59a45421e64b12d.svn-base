<%@ Page Title="报验记录" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="CheckAcceptance.aspx.cs" Inherits="Module_FM2E_ArchivesManager_SearchPages_CheckAcceptance" %>
