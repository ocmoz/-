<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="EditScrapApply.aspx.cs" Inherits="Module_FM2E_DeviceManager_AssetManager_ScrapManager_ScrapApply_EditScrapApply" Title="无标题页" %>
