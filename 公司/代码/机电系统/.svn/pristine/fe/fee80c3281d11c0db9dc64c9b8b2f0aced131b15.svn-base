...
public partial class Module_FM2E_BudgetManager_MonthlyBudgetManager_ShowChart : System.Web.UI.Page
{
    long id = (long)Common.sink("MonthlyID", MethodType.Get, 255, 0, DataType.Long);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (id != 0)
        {
            ...
            newViewer.workflowstate = budgetpermonthtotalinfo.WorkFlowStateName;
        }
