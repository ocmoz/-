<%@ Page Title="采购查询" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="QueryPurchase.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_QueryPurchase" %>
