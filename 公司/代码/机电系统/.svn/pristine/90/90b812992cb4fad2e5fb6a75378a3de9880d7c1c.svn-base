...
function showPopWin(Title,url, width, height, returnFunc, showCloseBox,showScrolling) {
	...
	bodyOverflow = theBody.style.overflow;
...
//		    frameScrolling = window.parent.document.getElementById("mainFrame").scrolling;
//		}
//		
//		window.parent.document.getElementById("mainFrame").scrolling = "no";
...
function hidePopWin(callReturnFunc) {
	...
	theBody.style.overflow = bodyOverflow;

	
//	if (window.parent.document.getElementById("mainFrame") != null) {
//	    window.parent.document.getElementById("mainFrame").scrolling = "auto";
//	}
...
function hideSelectBoxes() {
    ...
    for (i = 0; x && i < x.length; i++) {
        x[i].setAttribute('orginalState', x[i].style.visibility);
...
function displaySelectBoxes() {
    ...
    for (i = 0; x && i < x.length; i++) {
        x[i].style.visibility = x[i].orginalState;
    }
}
