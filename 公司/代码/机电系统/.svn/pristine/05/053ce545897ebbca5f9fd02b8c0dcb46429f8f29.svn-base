...
public partial class Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainView_RoutineMaintainConfig : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("RoutineMaintainTrack.aspx?cmd=view&id=" + id);
        }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string click = "javascript:showPopWin('查看跟踪对比信息','RoutineMaintainTrack.aspx?itemID=" + item.ItemID.ToString() + "&minDate=" + TBMinTime.Text.Trim() + "&maxDate=" + TBMaxTime.Text.Trim() + "', 900, 450, addtolist,true,true);return false;";
