<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Marketing.aspx.cs" Inherits="Module_FM2E_Report_Output_Marketing" %>
		...
		<!--
			...
			<div id="main-tablist">
				<div id="button-bar">
					<ul>
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px;color:Gray;  width: 100px;cursor: hand;"
						...
						<ul>
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px; color:Gray; width: 68px;cursor: hand;"
					...
					<ul>
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px; width: 200px;cursor: hand;"
								onclick="javascript:jump('Yingxiao_Shoufeizhan_MarketingWorkPlan_o_s.raq','<%=station%>')"
								value="收费站营销工作计划" />
						</li>
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px; width: 200px;cursor: hand;"
								onclick="javascript:jump('Yingxiao_Shoufeizhan_Cheliu_o_s.raq','<%=station%>')"
								value="收费站车流量统计月报" />
						</li>
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px; width: 252px; cursor: hand;"
								onclick="javascript:jump('Yingxiao_Shoufeizhan_Cheliuliang_o_s.raq','<%=station%>')"
						...
						<li>
							<input type="button" style="font-family: 微软雅黑; height: 30px; width: 200px;cursor: hand;"
								onclick="javascript:jump('Yingxiao_Shoufeizhan_Gaofeng_o_s.raq','<%=station%>')"
								value="高峰应急统计月报" />
						</li>
					</ul>
					--%>
