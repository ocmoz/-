<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MasterPage.master" EnableEventValidation="false" CodeFile="ImportConsumableEquipment.aspx.cs" Inherits="Module_FM2E_DeviceManager_DeviceInfo_ConsumableEquipmentManager_ImportConsumableEquipment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="易耗品设备信息维护"
        HeadOPTxt="目前操作功能：易耗品设备信息维护">
    ...
    <div style="width: 100%;">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            ...
            <HeaderTemplate>设备批量导入</HeaderTemplate>
            <ContentTemplate>
