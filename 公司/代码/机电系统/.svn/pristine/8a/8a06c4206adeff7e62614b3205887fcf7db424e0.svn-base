...
public partial class Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainView_RoutineMaintainTrack : System.Web.UI.Page
{
    ...
    protected void btnReport1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            reportdocument.Load(Server.MapPath("~") + "/report/RoutineMaintain/RoutineMaintainGrahpReport.rpt");
                ...
                case MaintainPlanPeriodUnit.Year:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineMaintain/RoutineMaintainListReport1.rpt");
                        break;
                    }
                case MaintainPlanPeriodUnit.Season:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineMaintain/RoutineMaintainListReport2.rpt");
                        break;
                    }
                case MaintainPlanPeriodUnit.Month:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineMaintain/RoutineMaintainListReport3.rpt");
                        break;
                    }
                ...
                case MaintainPlanPeriodUnit.Day:
                    {
                        ...
                        reportdocument.Load(Server.MapPath("~") + "/report/RoutineMaintain/RoutineMaintainListReport4.rpt");
                        break;
                    }
            }
