...
{
    [Serializable]
    public class QuarterlyBudgetDetailInfo
    {
        #region Model
        ...
        public static QuarterlyBudgetDetailInfo CloneObject(QuarterlyBudgetDetailInfo obj)
        {
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                stream.Position = 0;
                return (QuarterlyBudgetDetailInfo)formatter.Deserialize(stream);
            }
        }
