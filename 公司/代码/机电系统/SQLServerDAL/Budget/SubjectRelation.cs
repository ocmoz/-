...
namespace FM2E.SQLServerDAL.Budget
{
    ...
    {
        private const string DEL_SUBJECTRELATION = "delete from FM2E_SubjectRelation where SubID = '{0}'";

        private const string UPDATE_SUBJECTRELATION = " update FM2E_SubjectRelation set [ParentID]=@ParentID,[Name]=@Name,[CompanyID]=@CompanyID,[IsLeaf]=@IsLeaf where [SubID]=@SubID";

        private const string INSERT_SUBJECTRELATION = " insert into FM2E_SubjectRelation(ParentID,Name,CompanyID,IsLeaf) values(@ParentID,@Name,@CompanyID,@IsLeaf)";

        private const string TableName = " FM2E_SubjectRelation AS su1 LEFT OUTER JOIN FM2E_SubjectRelation AS su2 ON su1.ParentID = su2.SubID ";
        ...
        private const string TableName2 = " FM2E_SubjectPerYear AS su1 LEFT OUTER JOIN FM2E_SubjectPerYear AS su2 ON su1.ParentID = su2.SubID and su1.Year = su2.Year ";
        ...
        {
            string cmd = " select  distinct Name from FM2E_SubjectPerYear where 1=1 ";
