...
public partial class Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolView_DailyPatrolConfig : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("DailyPatrolTrack.aspx?cmd=view&id=" + id);
        }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            string click = "javascript:showPopWin('查看跟踪对比信息','DailyPatrolTrack.aspx?itemID=" + item.ItemID.ToString() + "&minDate=" + TBMinTime.Text.Trim() + "&maxDate=" + TBMaxTime.Text.Trim() + "', 900, 450, addtolist,true,true);return false;";
