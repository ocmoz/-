...
public partial class Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainConfig_SelectDevice : System.Web.UI.Page
{
    ...
    private void ButtonBind()
    {
        ...
        button.ButtonUrl = string.Format("ViewRoutineMaintainConfig.aspx?cmd=view&id={0}", id);
    }
