...
public partial class Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainConfig_RoutineMaintainConfig : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            if (search)
            {
                ...
                item.PlanObject = Common.inSQL(tbPlanObject.Text.Trim());
            }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ViewRoutineMaintainConfig.aspx?cmd=view&id=" + id);
        }
