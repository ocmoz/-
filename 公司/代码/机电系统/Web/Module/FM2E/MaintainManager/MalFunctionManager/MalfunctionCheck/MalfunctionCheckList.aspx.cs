...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_MalfunctionCheckList : System.Web.UI.Page
{
    ...
    private MalfunctionSearchInfo SearchTerm
    {
        get
        {
            if (ViewState["SearchTerm"] == null)
            {
                ...
                term.Status = (int)MalfunctionHandleStatus.Waiting4Check +(int)MalfunctionHandleStatus.Waiting4ReporterCheck;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //验收
            Response.Redirect("CheckMalfunctionSheet.aspx?cmd=view&id=" + id);
        }
