...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_DelayMalfunctionList : System.Web.UI.Page
{
    ...
    private MalfunctionSearchInfo SearchTerm
    {
        get
        {
            if (ViewState["SearchTerm"] == null)
            {
                ...
                term.Status = (int)MalfunctionHandleStatus.Delay;
                //term.RecordDept = WebUtility.UserData.CurrentUserData.DepartmentID;
                term.IsDelayApply = 1;
                term.FirstDelayApprove = 0;
                return term;
            }
    ...
    private void FillData()
    {
        try
        {
            ...
            //查询
            int recordCount = 0;
            IList list = malfunctionBll.GetDelayApproveMalfunctionList(term, AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, out recordCount);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //验收
            Response.Redirect("DelayMalfunctionSheet.aspx?cmd=view&id=" + id);
        }
    ...
    private void GetSearchTerm()
    {
       ...
       // term.Status = (int)MalfunctionHandleStatus.Wait4Canceled;
       // term.RecordDept = WebUtility.UserData.CurrentUserData.DepartmentID;
        SearchTerm = term;
    }
    /// <summary>
