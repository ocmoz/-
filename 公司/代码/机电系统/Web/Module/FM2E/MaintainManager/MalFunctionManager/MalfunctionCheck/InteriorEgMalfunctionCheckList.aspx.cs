...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_InteriorEgMalfunctionCheckList : System.Web.UI.Page
{
    ...
    private MalfunctionSearchInfo SearchTerm
    {
        get
        {
            if (ViewState["SearchTerm"] == null)
            {
                ...
                term.Status = (int)MalfunctionHandleStatus.Wait4EngineerCheck;
                //term.MaintainDept = WebUtility.UserData.CurrentUserData.DepartmentID;
                return term;
            }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //验收
            Response.Redirect("InteriorEgCheckMalfunctionSheet.aspx?cmd=view&id=" + id);
        }
