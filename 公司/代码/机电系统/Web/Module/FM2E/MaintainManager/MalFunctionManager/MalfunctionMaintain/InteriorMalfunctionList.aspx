<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="InteriorMalfunctionList.aspx.cs" Inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionMaintain_InteriorMalfunctionList" %>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="故障处理"
        HeadHelpTxt="默认显示最新的待处理故障单" HeadOPTxt="目前操作功能：故障处理单列表">
            ...
            ButtonPopedom="List" ButtonUrl="InteriorMalfunctionSheets.aspx" />
            <cc1:HeadMenuButtonItem ButtonName="查看所有的故障单" ButtonIcon="list.gif" ButtonUrlType="Href"
            ButtonPopedom="List" ButtonUrl="InteriorMyMalfunctionSheets.aspx" />
                 ...
                 <table width="100%">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReportDate" DataFormatString="{0:yyyy-MM-dd}" 
                                HeaderText="报修时间" HtmlEncode="False">
                            <HeaderStyle Width="7%" />
                            </asp:BoundField>
                            ...
                            <asp:ButtonField ButtonType="Image" CommandName="view" HeaderText="处理" 
                                ImageUrl="~/images/ICON/Approval.gif">
                            <HeaderStyle Width="4%" />
                            </asp:ButtonField>
                        </Columns>
