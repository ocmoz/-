...
public partial class Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionApproval_MalfunctionApprovalList : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            //查询
            int recordCount = 0;
            IList list = malfunctionBll.GetMalfunctionApprovalList(term,WebUtility.Common.Get_UserName, AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, out recordCount);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //查看
            string url = "ViewApprovalMfSheet.aspx?cmd=view&id=" + id;
