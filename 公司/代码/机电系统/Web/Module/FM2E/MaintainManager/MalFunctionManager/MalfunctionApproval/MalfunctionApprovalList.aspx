<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="MalfunctionApprovalList.aspx.cs" Inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionApproval_MalfunctionApprovalList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" Runat="Server">
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="故障处理单审批"
        HeadHelpTxt="默认显示待审批的故障处理单" HeadOPTxt="目前操作功能：故障处理单审批列表">
