<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true"
    CodeFile="DeviceInfo.aspx.cs" Inherits="Module_FM2E_DeviceManager_DeviceInfo_CurrentEuipementInfo_AllEquipmentInfo_DeviceInfo"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="在用设备管理"
        HeadOPTxt="目前操作功能：在用设备管理" HeadHelpTxt="设备列表默认显示新添设备">
                                    ...
                                    <td valign="top" style="width: 80%">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td>
                                                    系统：<asp:DropDownList ID="DropDownList_FilterSystem" runat="server" OnSelectedIndexChanged="OnFilter"
                                                        AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                        ...
                                        <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                                            ...
                                            <div style="text-align: left;">
                                                当前设备共量为：<asp:Label ID="lbCurrentDeviceCount" runat="server"></asp:Label></div>
                                        </div>
                                    </td>
                                </tr>
                            </table>
