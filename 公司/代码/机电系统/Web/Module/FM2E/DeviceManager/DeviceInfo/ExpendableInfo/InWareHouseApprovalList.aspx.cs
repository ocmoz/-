...
public partial class Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_InWarehouseApprovalList : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            IList list = bll.GetSearchInWarehouseApply(info, AspNetPager1.CurrentPageIndex, AspNetPager1.PageSize, WebUtility.Common.Get_UserName, out listCount);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            //查看
            Response.Redirect("InWarehouseApprove.aspx?cmd=view&id=" + id);  
        }
    }
    /// <summary>
    /// GridView数据绑定事件
