...
public partial class Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_ViewOutWarehouse : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HeadMenuWebControls1.ButtonList[0].ButtonUrl = "OutWarehouse.aspx?cmd=edit&id=" + id;
    ...
    private void FillData()
    {
        try
        {
            ...
            if (info.CurrentStateName == OutWarehouseInfoStatus.ReturnModify.ToString())//如果表单状态是返回修改
            {
            ...
            LB_OWRemark.Text=info.Remark;
            LB_OWName.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).Name;
            LB_OWModel.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).Model;
            LB_OWCount.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).Count.ToString();
            LB_OWUnit.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).Unit;
            LB_OWCategory.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).ExpendableType;
            LB_OWPrice.Text = ((FM2E.Model.Equipment.InEquipmentsInfo)(info.OutWarehouseList[0])).ExpendablePrice.ToString();
        }
        catch (Exception ex)
        {
