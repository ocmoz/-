...
public partial class Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_OutWarehouseApply : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ViewOutWarehouse.aspx?cmd=view&id=" + id);
        }
    }
