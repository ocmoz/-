<%@ Page Title="核实报验单" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ConfirmCAForm.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_ExecutePurchasing_ConfirmCAForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件采购"
        HeadOPTxt="目前操作功能：验收" HeadHelpTxt="浅黄色部分为需要您核实的项">
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回采购单列表" ButtonUrlType="Href"
            ButtonPopedom="List" ButtonUrl="ExecutePurchasing.aspx" />
                ...
                <td colspan="4">
                    <asp:UpdatePanel runat="server" ID="UpdataPanel_GridView">
                        ...
                        <table id="table_PurchaseRecordList" style="width: 100%; border-collapse: collapse;
                            ...
                            <asp:Repeater ID="Repeater_PurchaseRecordList" runat="server" OnItemDataBound="Repeater_ItemList_RowDataBound"  OnItemCommand="Repeater_ItemList_RowCommand">
                                <ItemTemplate>
                                    <tr id="tr_item" runat="server">
                                        <td style="text-align: center">
                                            <asp:Label ID="Label_ID" runat="server" Text='<%# Eval("ID") %>'></asp:Label>
                                            <asp:Label ID="Label_ItemID" runat="server" Text='<%# Eval("ItemID") %>' Visible=false></asp:Label>
                                        ...
                                        <td style="text-align: center">
                                            <asp:Button ID="Button_Confirm" runat="server" Text="核实" CssClass="button_bak" OnClientClick="javascript:return confirm('确认核实？');" CommandName="CONFIRM" CommandArgument='<%# Eval("ItemID") %>' />
