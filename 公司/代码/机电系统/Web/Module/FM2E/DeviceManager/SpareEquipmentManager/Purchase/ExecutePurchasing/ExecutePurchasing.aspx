<%@ Page Title="执行采购" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="ExecutePurchasing.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_ExecutePurchasing_ExecutePurchasing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="执行采购"
        HeadOPTxt="目前操作功能：当前分配采购任务列表">
        <cc1:HeadMenuButtonItem ButtonIcon="move.gif" ButtonName="送仓报验" ButtonUrlType="Href"
            ButtonUrl="SendWarehouse.aspx" ButtonPopedom="New" />
        <cc1:HeadMenuButtonItem ButtonIcon="select.gif" ButtonName="采购历史" ButtonUrlType="Href"
            ButtonUrl="ExecutePurchasingHistory.aspx" ButtonPopedom="List" />
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                    <span style="color: Blue; font-weight: bold">
                        <%= WebUtility.UserData.CurrentUserData.PersonName %>(<%= WebUtility.UserData.CurrentUserData.UserName %>)</span>&nbsp;正在处理的采购单
                </td>
            </tr>
            <tr>
                                ...
                                <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="申购单">
                                            <ItemTemplate>
                                                <a style="color: Blue" href='Purchase.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
        ...
        <table id="Table1" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                    ...
                    等待 <span style="color: Blue; font-weight: bold">
                        <%= WebUtility.UserData.CurrentUserData.PersonName %>(<%= WebUtility.UserData.CurrentUserData.UserName %>)</span>核实的报验单
                </td>
            </tr>
            <tr>
                <td class="table_none_NoWidth">
                                ...
                                <asp:GridView ID="gridview_check" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="报验单">
                                            <ItemTemplate>
                                                <a style="color: Blue" href='ConfirmCAForm.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
