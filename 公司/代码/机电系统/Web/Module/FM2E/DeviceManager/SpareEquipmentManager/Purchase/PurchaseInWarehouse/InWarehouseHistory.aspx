<%@ Page Title="设备入库历史" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master"
    AutoEventWireup="true" CodeFile="InWarehouseHistory.aspx.cs" Inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseInWarehouse_InWarehouseHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件入库历史"
        HeadOPTxt="目前操作功能：入库单历史列表" HeadHelpTxt="以下为本仓库经过入库的清单">
            <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回入库" ButtonUrlType="Href"
            ButtonUrl="InWarehouse.aspx" ButtonPopedom="List" />
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle">
                  <asp:Label ID="Label_WarehouseName" ForeColor="Blue" runat="server" Font-Bold="true"></asp:Label>完成入库的采购单
                </td>
            </tr>
            <tr>
                                    ...
                                    <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="申购单">
                                                <ItemTemplate>
                                                    <a style="color: Blue" href='InWarehouseHistoryPurchaseOrder.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
