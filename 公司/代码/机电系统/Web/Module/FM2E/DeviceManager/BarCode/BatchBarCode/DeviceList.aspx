<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="DeviceList.aspx.cs" Inherits="Module_FM2E_DeviceManager_BarCode_BatchBarCode_DeviceList" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="条形码批量打印"
        HeadOPTxt="目前操作功能：条形码批量打印" HeadHelpTxt="设备列表默认显示设备">
                                    ...
                                    <td  valign="top" style="width:80%">
                                        <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                                            <div id="PrintDiv" style="width: 100%;">
                                                <input id="Button_AddItem" type="button" runat="server" value="添加" style="display: none" onserverclick="Button_AddItem_Click" />
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="选取"> 
                                                            ...
                                                            <ItemTemplate> 
                                                              ...
                                                              <%--<asp:CheckBox ID="chkSelectThis" runat="server" OnCheckedChanged="chkSelectThis_CheckedChanged" />--%>
                                                            </ItemTemplate> 
