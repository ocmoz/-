...
public partial class Module_FM2E_DeviceManager_BarCode_BatchBarCode_DeviceList : System.Web.UI.Page
{
    ...
    //        {
    //            ((HtmlInputCheckBox)GridView1.Rows[i].FindControl("chkSelectThis")).Checked = true;
    //        }
    //    }
    //    else
    //    {
    //        for (i = 0; i < GridView1.Rows.Count; i++)
    //        {
    //            ((HtmlInputCheckBox)GridView1.Rows[i].FindControl("chkSelectThis")).Checked = false;
    //        }
    //    }
    //}
    ...
    protected void chkSelectThis_CheckedChanged(object sender, EventArgs e)
    {
        ...
        //((HtmlInputCheckBox)GridView1.Rows[GridView1.SelectedIndex].FindControl("chkSelectThis")).Checked = ((CheckBox)sender).Checked;
    }
