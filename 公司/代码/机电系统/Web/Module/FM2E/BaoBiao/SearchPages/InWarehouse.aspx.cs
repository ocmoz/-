...
public partial class Module_FM2E_ArchivesManager_SearchPages_InWarehouse : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        ...
        if (searchTerm == null)
        {
            ...
            item.DepartmentID = DropDownList_Department.SelectedValue == "" ? 0 : long.Parse(DropDownList_Department.SelectedValue);
