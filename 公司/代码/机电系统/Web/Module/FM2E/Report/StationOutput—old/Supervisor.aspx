<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Supervisor.aspx.cs" Inherits="Module_FM2E_Report_Output_Supervisor" %>
			...
			<div id="main-tablist">
				<div id="button-bar">
					<ul>
						...
						<li>
							<input type="button" style="font-family: 微软雅黑;height: 29px; text-align: center; width: 200px;cursor: hand;"
								onclick="javascript:jump('Dudao_Zichayuebao_o.raq','<%=station%>')"
								value="月度自查情况" />
						</li>
						<li>
							<input type="button" style="font-family: 微软雅黑;height: 29px; text-align: center; width: 200px;cursor: hand;"
								onclick="javascript:jump('Dudao_Wenmingfuwu_o.raq','<%=station%>')"
								value="文明服务月报" />
						</li>
						--%>
