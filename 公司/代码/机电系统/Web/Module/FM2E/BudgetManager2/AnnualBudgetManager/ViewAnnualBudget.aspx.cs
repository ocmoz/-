...
public partial class Module_FM2E_BudgetManager_AnnualBudgetManager_ViewAnnualBudget : System.Web.UI.Page
{
    ...
    private void ButtonBind()
    {
        ...
        button2.ButtonUrl = "MakeAnnualBudget.aspx?cmd=edit&id=" + id;

        HeadMenuButtonItem button3 = HeadMenuWebControls1.ButtonList[3];
        button3.ButtonUrlType = UrlType.JavaScript;
        button3.ButtonUrl = string.Format("DelData('?cmd=delete&id={0}');", id);

        HeadMenuButtonItem button4 = HeadMenuWebControls1.ButtonList[4];
        //button4.ButtonUrl = "ShowChart.aspx?YearID=" + id + "&workflowname=" + BudgetYearWorkflow.WorkflowName;
        ...
        if (cmd == "delete")
        {
            ...
            if(bSuccess == true)
                EventMessage.MessageBox(Msg_Type.Info, "操作成功", "删除年度预算所有信息成功！", Icon_Type.OK, true, Common.GetHomeBaseUrl("AnnualBudget.aspx"), UrlType.Href, "");
