...
public partial class Module_FM2E_BudgetManagement_QuarterlyForecast_QuarterlyForecast : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            int recordCount = 0;
            IList list = bll.GetQuarterlyForecastTotalList(qp, out recordCount, null);
        ...
        {
            EventMessage.MessageBox(Msg_Type.Error, "操作失败", "获取季度预测列表失败", ex, Icon_Type.Error, true, "window.history.go(-1)", UrlType.JavaScript, "");
        }
    }
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            QuarterlyForecastTotalInfo dv = (QuarterlyForecastTotalInfo)e.Row.DataItem;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "view")
        {
            ...
            Response.Redirect("ViewQuarterlyForecast.aspx?cmd=view&id=" + TotalID);
        }
        if (e.CommandName == "del")
        {
            ...
            if (budgetpermonthtotalinfo == null)
                EventMessage.MessageBox(Msg_Type.Error, "操作失败", "本季度预测已被删除！", new WebException("本季度预测已被删除！"), Icon_Type.Error, true, "history.go(-1)", UrlType.JavaScript, "");
