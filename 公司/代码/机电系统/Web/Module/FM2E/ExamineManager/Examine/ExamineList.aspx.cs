...
public partial class Module_FM2E_ExamineManager_Examine_ExamineList : System.Web.UI.Page
{
    /// <summary>
    /// 考核业务处理对象
    /// </summary>
    ...
    private void PermissionControl()
    {
        ...
        gvExamineSheets.Columns[gvExamineSheets.Columns.Count - 1].Visible = SystemPermission.CheckPermission(PopedomType.Delete);
    }
    //********** Modification Finished 2011-09-09 **********************************************************************************************
    ...
    private void InitialPage()
    {
        ...
        //考核表状态
        ListItem[] statuses = EnumHelper.GetListItems(typeof(ExamineSheetStatus), (int)ExamineSheetStatus.Unknown);

        ddlStatus.Items.Clear();
        ddlStatus.Items.Add(new ListItem("不限", ((int)ExamineSheetStatus.Unknown).ToString()));
        ddlStatus.Items.AddRange(statuses);
    ...
    private ExamineSearchInfo GetSearchTerm()
    {
        ...
        item.Status = (ExamineSheetStatus)Convert.ToInt32(ddlStatus.SelectedValue);
    ...
    protected void gvExamineSheets_RowCommand(object sender, GridViewCommandEventArgs e)
    {
          ...
          {
              case "view":
                  Response.Redirect("ViewExamine.aspx?cmd=view&id=" + id);
                  break;
              case "del":
                  //删除
                  try
