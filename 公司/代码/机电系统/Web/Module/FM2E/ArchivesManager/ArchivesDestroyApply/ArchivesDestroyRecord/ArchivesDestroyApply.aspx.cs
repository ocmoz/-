...
public partial class Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyRecord_ArchivesDestroyApply : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            if (!search)
            {
                ...
                item.Applicant = "";
                item.ApplicantName = "";
                item.ApplyStatus = ArchivesDestroyApplyStatus.ApprovalPassed;
    ...
    private void FillData2()
    {
        try
        {
            ...
            if (!search)
            {
                ...
                item.Applicant = "";
                item.ApplicantName = "";
                item.ApplyStatus = ArchivesDestroyApplyStatus.Destroyed;
                searchTerm = bll.GenerateSearchTerm(item);
            }
            else
            {
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ArchivesDestroyRecord.aspx?cmd=destroy&id=" + id);
        }
    }
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ArchivesDestroyRecord.aspx?cmd=viewArchives&id=" + id);
        }
    }
