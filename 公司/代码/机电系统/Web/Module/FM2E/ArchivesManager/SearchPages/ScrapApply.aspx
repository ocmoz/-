<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ScrapApply.aspx.cs" Inherits="Module_FM2E_ArchivesManager_SearchPages_ScrapApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" Runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="设备报废档案信息查询"
    ...
    <div style="width:900px;height:300px;">
        ...
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
                    <cc2:TabPanel runat="server" HeaderText="设备报废单" ID="TabPanel1">
                        <HeaderTemplate>
                            设备报废单
                        </HeaderTemplate>
                        <ContentTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="查看">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/select.gif"
                                                    ...
                                                    Visible='<%#IsBorrowed(Convert.ToInt64(Eval("ScrapID")))==true?true:false%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
