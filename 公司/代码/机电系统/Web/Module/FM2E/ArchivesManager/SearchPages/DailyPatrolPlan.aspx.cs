...
public partial class Module_FM2E_ArchivesManager_SearchPages_DailyPatrolPlan : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            if (!search)
            {
                ...
                item.PlannerName = "";
                item.Status = 0;
                Array array = Enum.GetValues(typeof(DailyPatrolPlanStatus));
                ArrayList al = new ArrayList(array);
                al.Remove(DailyPatrolPlanStatus.UnKnownStatus);
                al.Remove(DailyPatrolPlanStatus.Draft);
                item.StatusArray = al;
            ...
            else
            {
                ...
                item.Status = (DailyPatrolPlanStatus)Convert.ToInt32(DDLStatus.SelectedValue);
                Array array = Enum.GetValues(typeof(DailyPatrolPlanStatus));
                ArrayList al = new ArrayList(array);
                al.Remove(DailyPatrolPlanStatus.UnKnownStatus);
                al.Remove(DailyPatrolPlanStatus.Draft);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            DailyPatrolPlanInfo item = (DailyPatrolPlanInfo)e.Row.DataItem;
