...
public partial class Module_FM2E_ArchivesManager_SearchPages_BorrowApply : System.Web.UI.Page
{
    ...
    private void FillData()
    {
        try
        {
            ...
            if (qp == null)
            {
                ...
                searchTerm.BorrowCompanyID = UserData.CurrentUserData.CompanyID;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        long borrowApplyID = Convert.ToInt64(gvRow.Attributes["ID"]);
        ...
        if (e.CommandName == "view")
        {
            ...
            Response.Redirect("../../" + node.Attributes["ViewUrl"].Value + "?cmd=viewArchives&id=" + borrowApplyID, false);
        }
    }
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Attributes["ID"] = item.BorrowApplyID.ToString();
