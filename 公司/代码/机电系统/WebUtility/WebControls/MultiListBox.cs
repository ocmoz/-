...
[assembly: WebResource("WebUtility.WebControls.Resource.moveAllLeft.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveAllLeft2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveAllRight.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveAllRight2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveLeft.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveLeft2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveRight.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.moveRight2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.sortDown.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.sortDown2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.sortUp.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.sortUp2.gif", "image/gif")]
[assembly: WebResource("WebUtility.WebControls.Resource.MultiListBox.js", "text/javascript")]
...
namespace WebUtility.WebControls
{
    ...
    public class MultiListBox : CompositeControl, IPostBackDataHandler
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            sb.AppendFormat("var {1}_multiList=new MultiListBox(document.getElementById('{1}_firstListBox'),document.getElementById('{1}_secondListBox'),'{1}_');{0}", Environment.NewLine, this.ClientID);
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            //显示FirstListBox列表框
            RenderOptionsContents(writer, FirstListBox, "firstListBox", string.Format("{0}_multiList.transferRight()",this.ClientID));
            writer.RenderEndTag();
            ...
            writer.RenderBeginTag(HtmlTextWriterTag.Td);
            //显示SecondListBox列表框
            RenderOptionsContents(writer, SecondListBox, "secondListBox", string.Format("{0}_multiList.transferLeft()",this.ClientID));
            writer.RenderEndTag();
            writer.RenderEndTag();
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            {
                //注册脚本
                string jsResource = Page.ClientScript.GetWebResourceUrl(typeof(MultiListBox), "WebUtility.WebControls.Resource.MultiListBox.js");
        ...
        protected void RenderMultiIcon(HtmlTextWriter writer)
        {
            ...
            RenderImageContents(writer, "moveAllRight.gif", string.Format("{0}_multiList.transferAllLeft();",this.ClientID), "_AllRight");//全部右移
            RenderImageContents(writer, "moveRight.gif", string.Format("{0}_multiList.transferRight();",this.ClientID), "_Right");
            RenderImageContents(writer, "moveLeft.gif", string.Format("{0}_multiList.transferLeft();", this.ClientID), "_Left");
            RenderImageContents(writer, "moveAllLeft.gif", string.Format("{0}_multiList.transferAllRight();",this.ClientID), "_AllLeft");
            writer.RenderEndTag();
        }

        private string GetWebResourceUrl(string img)
        {
            return Page.ClientScript.GetWebResourceUrl(typeof(MultiListBox), "WebUtility.WebControls.Resource." + img);
        }
