<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_ArchivesBorrowApply_ArchivesBorrowApply_ArchivesBorrowApply, App_Web_rqgyudmu" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="档案借阅申请信息维护"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加申请" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="EditArchivesBorrowApply.aspx?cmd=add" />
