<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyApply_ArchivesDestroyApply, App_Web_hza1l8bc" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="档案销毁申请信息维护"
        HeadOPTxt="目前操作功能：申请信息维护" HeadHelpTxt="申请列表默认显示新增申请">
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加申请" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="EditArchivesDestroyApply.aspx?cmd=add" />
