<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManager_MonthlyBudgetManager_MonthlyBudget, App_Web_jlbxoley" title="无标题页" %>
                        ...
                        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" Visible='<%# Eval("WorkFlowStateName")!=null && Eval("WorkFlowStateName").ToString() == BudgetMonthlyWorkflow.DraftState %>' runat="server" ImageUrl="~/images/ICON/delete.gif"
