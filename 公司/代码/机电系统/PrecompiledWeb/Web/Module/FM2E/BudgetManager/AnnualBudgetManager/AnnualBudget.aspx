<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManager_AnnualBudgetManager_AnnualBudget, App_Web__s54cybp" title="无标题页" %>
                        ...
                        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/delete.gif" Visible='<%# Eval("WorkFlowStateName")!=null && Eval("WorkFlowStateName").ToString() == BudgetYearWorkflow.DraftState %>'
