<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManager_AnnualBudgetApprovalManager_MakeAnnualBudget, App_Web_z-n3ycbc" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="年度预算审批"
        HeadOPTxt="目前操作功能：年度预算审批">
            ...
            <table id="theObjTable" style="table-layout: fixed" border="1">
                ...
                <tr align="center">
                    <td colspan="<%=companycount%>">
                        ...
                        <%--<input id="sure" type="button" value="提交"  onclick="javascript:return confirm('确定提交?');" class="button_bak" runat="server" onserverclick="Sure_Click" />--%>
