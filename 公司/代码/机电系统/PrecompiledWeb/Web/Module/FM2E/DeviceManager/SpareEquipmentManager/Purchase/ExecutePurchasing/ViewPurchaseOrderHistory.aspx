<%@ page title="查看采购单" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_ExecutePurchasing_ViewPurchaseOrderHistory, App_Web_j4wherg8" %>
...
<script type="text/javascript">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件采购"
        HeadOPTxt="目前操作功能：采购查看" HeadHelpTxt="浅黄色部分为您的采购项">
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回采购历史" ButtonUrlType="Href"
            ButtonPopedom="List" ButtonUrl="ExecutePurchasingHistory.aspx" />
