<%@ page title="查询指导价" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseApproval_QueryStorage, App_Web_4inv-6fo" %>
...
<iframe style="Z-INDEX:-1;WIDTH:99%;POSITION:absolute;TOP:0px;HEIGHT:435px" frameborder="0"></iframe>
    ...
    <table>
        <tr style=" height:20px;">
            <td class="table_body table_body_NoWidth" style="text-align: center; height:20px;
                width: 50px">
                产品名称
            </td>
            <td class="table_body table_body_NoWidth" style=" text-align: center; height:20px;
        ...
        <tr style=" height:20px;">
            <td class="table_none table_none_NoWidth" style=" width: 50px; height:20px">
            ...
            <td >
                <input class="button_bak" type="button" value="调整" runat="server" id="Button_Adjust" onclick="javascript:adjustItem();" />
