<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_OutWarehouse_OutWarehouseApproval_OutWarehouseApply, App_Web_dfxldiuv" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="设备出库申请审批"
        HeadOPTxt="目前操作功能：申请信息列表" HeadHelpTxt="申请列表默认显示新增申请">
    ...
    <div style="width: 100%; ">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                                ...
                                <asp:TemplateField HeaderText="审批">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/Approval.gif"
                                            CommandName="approval" CommandArgument='<%# Eval("ID") %>' CausesValidation="false"
                                             />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
                               <center><span style="color:Red">当前没有需要您审批的申请</span></center>
                            </EmptyDataTemplate>
                                ...
                                <asp:TemplateField HeaderText="查看">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/select.gif"
                                            CommandName="view" CommandArgument='<%# Eval("ID") %>' CausesValidation="false"
                                             />
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <cc2:TabPanel runat="server" HeaderText="审批历史查询" ID="TabPanel2">
                <ContentTemplate>
 ...
 <td class="table_body table_body_NoWidth">
                         ...
                         <td class="table_body table_body_NoWidth">
                            ...
                            <td class="table_none table_none_NoWidth">
                                <asp:TextBox ID="TextBox_ApprovalTimeLower" runat="server" CssClass="input_calender" onfocus="javascript:HS_setDate(this);"></asp:TextBox>至
                                <asp:TextBox ID="TextBox_ApprovalTimeUpper" runat="server"  CssClass="input_calender" onfocus="javascript:HS_setDate(this);"></asp:TextBox>
                            </td>  
                        </tr>
