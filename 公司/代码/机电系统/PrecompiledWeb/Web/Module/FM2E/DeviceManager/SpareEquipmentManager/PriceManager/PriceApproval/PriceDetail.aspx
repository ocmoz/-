<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_PriceManager_PriceApproval_PriceDetail, App_Web_gmhcmabw" %>
...
<script type="text/javascript">
    function clearbox() {
        ...
        document.getElementById('<%= TextBox_Applicant.ClientID %>').value = "";
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="3">
                ...
                <cc2:TabPanel runat="server" HeaderText="指导价格查询" ID="TabPanel5">
                    <ContentTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="审批">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/Approval.gif"
                                                ...
                                                Visible='<%#Convert.ToInt32(Eval("Status"))==2?true:false%>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
                ...
                <cc2:TabPanel runat="server" HeaderText="历史申请审批列表" ID="TabPanel4">
                    <ContentTemplate>
                        <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                            <asp:GridView Width="100%" ID="GridView4" runat="server" AutoGenerateColumns="False"
                            ...
                            <cc1:AspNetPager ID="AspNetPager4" runat="server" OnPageChanged="AspNetPager4_PageChanged"
                                AlwaysShow="True" CloneFrom="" CssClass="" CustomInfoClass="" CustomInfoHTML="总记录：0  页码：1/1  每页：10"
                                InvalidPageIndexErrorMessage="页索引不是有效的数值！" NavigationToolTipTextFormatString=""
                                PageIndexOutOfRangeErrorMessage="页索引超出范围！" ShowCustomInfoSection="Left">
                            </cc1:AspNetPager>
                ...
                <cc2:TabPanel runat="server" HeaderText="审批查询" ID="TabPanel6">
                    <ContentTemplate>
                        <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
