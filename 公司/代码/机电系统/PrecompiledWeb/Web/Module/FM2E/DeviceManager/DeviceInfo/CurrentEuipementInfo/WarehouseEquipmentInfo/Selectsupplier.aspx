<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_DeviceInfo_CurrentEuipementInfo_WarehouseEquipmentInfo_Selectsupplier, App_Web_komcswzl" %>
                                ...
                                <div style="width: 850px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SupplierID" HeaderText="供应商号">
                                            ...
                                            <asp:BoundField DataField="Product" HeaderText="供应产品">
                                                <HeaderStyle Width="80px" />
                                            </asp:BoundField>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td align="center">
                                            ...
                                            <input id="Button4" class="button_bak" type="button" value="关闭" onclick="javascript:window.parent.hidePopWin();" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
