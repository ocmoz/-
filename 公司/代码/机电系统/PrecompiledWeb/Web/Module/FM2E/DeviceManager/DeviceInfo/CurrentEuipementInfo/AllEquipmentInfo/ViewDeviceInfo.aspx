<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_DeviceInfo_CurrentEuipementInfo_AllEquipmentInfo_ViewDeviceInfo, App_Web_kt0jmzjw" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="在用设备管理"
        HeadOPTxt="目前操作功能：查看设备信息">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="设备信息列表" ButtonPopedom="List"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回" ButtonUrlType="href" ButtonPopedom="List" />
    ...
    <div style="width: 100%; ">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                    ...
                    <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        ...
                        <table style="width: 100%; border-collapse: collapse; vertical-align: middle; text-align: left;
                            ...
                            <tr>
                                ...
                                <td class="table_none table_none_NoWidth">
                                    <asp:Label ID="serialnum" runat="server"></asp:Label>
                                </td>
                                ...
                                <td rowspan="2" style="vertical-align: top;">
                                 ...
                                 <div id="div_basicequipment" runat="server">
                                          拆分自：<br />
                                          <asp:HyperLink ID="HyperLink_BasicDevice" runat="server" ForeColor="Blue" 
                            ...
                            <tr>
                                ...
                                <td class="table_none table_none_NoWidth">
                                    <asp:Label ID="Label_AssertNumber" runat="server"></asp:Label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="table_none table_none_NoWidth">
                                    <asp:Label ID="model" runat="server"></asp:Label><asp:Label ID="specification" 
                            ...
                            <td class="table_body table_body_NoWidth">
                                ...
                                <td class="table_none table_none_NoWidth">
                                    <asp:Label ID="systemname" runat="server" ></asp:Label>
                                </td>
                            ...
                            <tr>
                               ...
                               <asp:Label ID="Label_AddressName" runat="server"></asp:Label>     
                                    <asp:Label ID="Label_DetailLocation" runat="server"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="table_none table_none_NoWidth">
                                    <asp:Label ID="net" runat="server"></asp:Label>/<asp:Label ID="price" 
                                        runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
            ...
            <cc2:TabPanel ID="TabPanel6" runat="server" HeaderText="例行检测记录">
             ...
             <cc2:TabPanel runat="server" HeaderText="流转记录" ID="TabPanel7">
                <ContentTemplate>
                    <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        <asp:GridView ID="GridView5" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                              <asp:BoundField DataField="Type" HeaderText="类型" />
                                <asp:TemplateField HeaderText="单名">
                                    <ItemTemplate>
                                          <a style="color: Blue" href='<%# Eval("Url") %>'>
                                                        <asp:Label Text='<%# Eval("SheetNO") %>' runat="server" ID="Label_OrderID"></asp:Label>
                                                    </a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" Width="20%" />
                                </asp:TemplateField>                                
                                <asp:BoundField DataField="ReportDate" HeaderText="时间" />
                                <asp:BoundField DataField="Name" HeaderText="地点" />
                        ...
                        <cc1:AspNetPager ID="AspNetPager5" runat="server" OnPageChanged="AspNetPager5_PageChanged"
                            AlwaysShow="True" CloneFrom="" CssClass="" CustomInfoClass="" CustomInfoHTML="总记录：0  页码：1/1  每页：10"
                            InvalidPageIndexErrorMessage="页索引不是有效的数值！" NavigationToolTipTextFormatString=""
                            PageIndexOutOfRangeErrorMessage="页索引超出范围！" ShowCustomInfoSection="Left">
                        </cc1:AspNetPager>
                        <asp:Label ID="Label_TransferRecordError" ForeColor="Red" Visible="false" Text="维修记录读取失败"
                            runat="server"></asp:Label>
                    </div>
                </ContentTemplate>
            </cc2:TabPanel>
