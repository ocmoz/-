<%@ page title="查看采购单" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseInWarehouse_InWarehousePurchaseOrder, App_Web_e2vo_fnn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="备品备件采购"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回入库单列表" ButtonUrlType="Href"
            ButtonPopedom="List" ButtonUrl="InWarehouse.aspx" />
                                            ...
                                            <td colspan="8">
                                                <div runat="server" id="div_recordlist">
                                                    <table id="table_PurchaseRecordList" style="width: 100%; border-collapse: collapse;
                                                        ...
                                                        <asp:Repeater ID="Repeater_PurchaseRecordList" runat="server" DataSource='<%# Eval("PurchaseRecordList") %>'
                                                            OnItemDataBound="Repeater_ItemList_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr id="tr_item" runat="server">
                                                                    <td style="text-align: center">
                                                                        ...
                                                                        <input id="Hidden_Record_ItemID" runat="server" value='<%# Eval("PlanDetailItemID") %>'
                                                                            type="hidden" />
                                                                    ...
                                                                    <td style="text-align: center">
                                                                        <asp:Button ID="Button_InWarehouse" runat="server" Text="入库" CssClass="button_bak"
                                                                            OnClientClick='javascript:showWin(this.id);' />
    ...
    <asp:Button Text="保存" style="display:none" runat="server" ID="Button_Save" OnClick="Button_Save_Click" />
    <script type="text/javascript" language="javascript">
        ...
        //整套入库
        function showWin(id) {
            var orderid = document.getElementById(id.replace("Button_InWarehouse", "Hidden_Record_OrderID")).value;
            var itemid = document.getElementById(id.replace("Button_InWarehouse", "Hidden_Record_ItemID")).value;
            var recordid = document.getElementById(id.replace("Button_InWarehouse", "Hidden_PurchaseRecordID")).value;
            var warehouse = document.getElementById('<% =Hidden_WarehouseID.ClientID %>').value;
            showPopWin("执行入库", "DoInWarehouse.aspx?type=p&id=" + orderid + "&itemid=" + itemid + "&recordid=" + recordid + "&warehouse=" + warehouse, 900, 430, doconfirm, true, false);
        }
        //拆分
