<%@ page title="采购中心" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_Purchase_PurchaseCenter_PurchaseCenter, App_Web__gf_si04" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="采购中心--正在处理的申购单"
        HeadOPTxt="目前操作功能：分发申购单">
        <cc1:HeadMenuButtonItem ButtonIcon="select.gif" ButtonName="处理历史" ButtonUrlType="Href"
            ButtonUrl="PurchaseCenterHistory.aspx" ButtonPopedom="List" />
        ...
        <table id="RootTable" style="width: 100%; border-collapse: collapse; vertical-align: middle;
            ...
            <tr>
                <td class="Table_searchtitle" colspan="4">
                    <span style="color:Blue; font-weight:bold"> <%= WebUtility.UserData.CurrentUserData.CompanyName %></span> 采购中心等待分发以及正在进行的采购单
                </td>
            </tr>
            <tr>
                                    ...
                                    <asp:GridView ID="gridview_PurchaseApplyList" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="申购单">
                                                <ItemTemplate>
                                                    <a style="color: Blue" href='DeliveryPurchaseOrder.aspx?id=<%# DataBinder.Eval(Container.DataItem,"ID") %>&cmd=history'>
