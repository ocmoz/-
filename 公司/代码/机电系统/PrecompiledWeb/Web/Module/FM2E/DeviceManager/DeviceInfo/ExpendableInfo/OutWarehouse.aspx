<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_OutWarehouse, App_Web_4xxpdmqi" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" Runat="Server">
    <table style="width: 100%; border-collapse: collapse; vertical-align: middle; text-align: left;
        ...
        <tr>
            ...
            <td class="table_none table_none_NoWidth">
               <asp:Label ID="OutWarehouseText" runat="server" />
            </td>
        </tr>       
        <tr>
                        ...
                        <tr>
                            <td colspan="4" align="center">
                                <asp:Button ID="btSubmit" runat="server" CssClass="button_bak2" Text="保存或提交申请" OnClientClick="javascript:return confirm('确定提交或保存？');"
                                    OnClick="Button_SaveOutWarehouse_Click" />&nbsp;&nbsp;
                                <input id="Reset1" class="button_bak" runat="server" type="button" value="取消" onclick="javascript:window.parent.hidePopWin();" />
                                <input id="Reset2" class="button_bak" runat="server" type="button" value="返回" onclick="javascript:window.history.go(-1);"
                                    stytle="display:none" />
                            </td>
                        </tr>
                    </table>
