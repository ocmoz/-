<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_OutWarehouseApprove, App_Web_4xxpdmqi" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
 ...
 <script type="text/javascript">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="易耗品出库申请单审批"
        HeadHelpTxt="帮助" HeadOPTxt="目前操作功能：易耗品出库申请单审批">
