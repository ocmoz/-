<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_OutWarehouse_OutWarehouseRecord_OutWarehouseRecord, App_Web_eb5tpfb1" title="Untitled Page" %>
                        ...
                        <ContentTemplate>
                            ...
                            <center>
                                        <asp:Label ID="LblErrorMessage" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                                            ...
                                                                            <asp:Button ID="Button4" runat="server" CssClass="button_bak" Text="完成" OnClick="Button4_Click"  />
                                    </center>
                        </ContentTemplate>
                    </cc2:TabPanel>
                </cc2:TabContainer>
