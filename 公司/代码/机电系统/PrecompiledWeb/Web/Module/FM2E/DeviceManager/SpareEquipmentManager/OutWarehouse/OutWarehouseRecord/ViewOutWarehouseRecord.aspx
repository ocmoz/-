<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_OutWarehouse_OutWarehouseRecord_ViewOutWarehouseRecord, App_Web_eb5tpfb1" title="Untitled Page" %>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                                            <table border="1px" style="width: 100%; border-collapse: collapse; vertical-align: middle; 
                                border: solid 1px #a7c5e2;">
                                                ...
                                                <asp:Repeater ID="Repeater_Detail" runat="server">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td colspan="8">
                                                                <asp:GridView ID="GridView_OutDetail" runat="server" 
                                                                    AutoGenerateColumns="False" DataSource='<%# Eval("OutEquipmentList") %>' 
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="Count" DataFormatString="{0:#,0.#####}" 
                                                                            HeaderText="数量" />
                                                                        <asp:BoundField DataField="Unit" HeaderText="单位" />
                                                                        <asp:BoundField DataField="OutTime" DataFormatString="{0:yyyy-MM-dd HH:mm}" 
                                                                            HeaderText="出库时间" HtmlEncode="false" />
