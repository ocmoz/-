<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_DeviceInfo_ExpendableInfo_ViewOutWarehouse, App_Web_4xxpdmqi" title="易耗品出库单查看" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
 <script type="text/javascript" src="<%=Page.ResolveUrl("~/") %>inc/FineMessBox/js/common.js"></script>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="易耗品出库单查看"
        HeadHelpTxt="帮助" HeadOPTxt="目前操作功能：易耗品出库单查看">
        ...
        text-indent: 13px; border: solid 1px #a7c5e2;" border="1">
                           ...
                           <table>
                                        <tr>
                                            ...
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWName" runat="server" /><%# Eval("Name")%>
                                            </td>
                                            <td class="table_body table_body_NoWidth">
                                                型号：
                                            </td>
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWModel" runat="server" /><%# Eval("Model")%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_body table_body_NoWidth">
                                            ...
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWCount" runat="server" /><%# Eval("Count")%>
                                            </td>
                                            <td class="table_body table_body_NoWidth" >
                                                单位：
                                            </td>
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWUnit" runat="server" /><%# Eval("Unit")%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="table_body table_body_NoWidth" >
                                            ...
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWCategory" runat="server" /><%# Eval("CategoryName")%>
                                            </td>
                                            <td class="table_body table_body_NoWidth" >
                                                单价：
                                            </td>
                                            <td class="table_none table_none_NoWidth" >
                                                <asp:Label ID="LB_OWPrice" runat="server" /><%# Eval("ExpendablePrice")%>
                                            </td>
                                        </tr>
                                    </table>
          ...
          <tr>
            ...
            <td class="table_none table_none_NoWidth" colspan="3">
                <asp:Label ID="LB_OWRemark" runat="server" />
            </td>
        </tr>
        <tr>
