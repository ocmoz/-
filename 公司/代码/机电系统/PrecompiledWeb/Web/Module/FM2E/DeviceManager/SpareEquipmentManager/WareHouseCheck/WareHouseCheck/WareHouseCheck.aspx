<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_WareHouseCheck_WareHouseCheck_WareHouseCheck, App_Web_ajp3ytvr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="仓库检查表填写"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加仓库检查表" ButtonPopedom="New" ButtonUrl="EditCheckForm.aspx?cmd=add" ButtonUrlType="Href" />
                            ...
                            <tr>
                                ...
                                <td class="table_none table_none_NoWidth" style="height: 30px">
                                    <asp:DropDownList ID="ddlStatus" runat="server">
                                        ...
                                        <asp:ListItem Text="已提交" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="已结束" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td class="table_body table_body_NoWidth" style="height: 30px">
                                    检查时间：
