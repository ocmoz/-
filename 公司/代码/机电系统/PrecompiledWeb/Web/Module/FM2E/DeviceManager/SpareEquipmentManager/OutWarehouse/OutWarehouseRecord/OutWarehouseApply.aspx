<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_SpareEquipmentManager_OutWarehouse_OutWarehouseRecord_OutWarehouseApply, App_Web_eb5tpfb1" title="Untitled Page" %>
                ...
                <ContentTemplate>
                    <div style="width: 100%; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        ...
                        <cc1:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" OnPageChanged="AspNetPager1_PageChanged"
                            CssClass="" CustomInfoClass="" 
                            CustomInfoHTML="总记录：&lt;font color='red'&gt;0&lt;/font&gt;  页码：1/1  每页：" InvalidPageIndexErrorMessage="页索引不是有效的数值！"
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                           ...
                           <td class="table_body table_body_NoWidth" style="height: 30px">
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">                              
    <asp:DropDownList ID="ddl_WarehouseName" runat="Server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
