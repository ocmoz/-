<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_DeviceManager_DeviceInfo_CurrentEuipementInfo_AllEquipmentInfo_EditDevice, App_Web_kt0jmzjw" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="设备信息维护"
        HeadOPTxt="目前操作功能：设备信息维护">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" title="" style="height: 30px">
                                ...
                                </asp:UpdatePanel><span style="color: Red">*</span>
                            </td>
                            <td class="table_body table_body_NoWidth">
                                采购日期：
                            </td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <td class="table_none table_none_NoWidth">
                                <asp:DropDownList ID="SectionName" runat="server">
                                    <asp:ListItem>--请选择--</asp:ListItem></asp:DropDownList></td></tr><tr style="display: none">
                            <td class="table_body table_body_NoWidth">
                                位置类型：
                            </td>
                            <td class="table_none table_none_NoWidth">
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:TextBox ID="Price" title="价格输入格式不正确~float" runat="server"></asp:TextBox></td><td class="table_body table_body_NoWidth" style="height: 30px">
                                单位：
                            </td>
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:DropDownList ID="DDLUnit" runat="server" title="请选择设备单位~!"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth">
                            ...
                            <td class="table_none table_none_NoWidth">
                                <asp:TextBox ID="MaintenanceTimes" title="维修次数输入格式不正确~int!" runat="server" Text="0"></asp:TextBox></td><td class="table_body table_body_NoWidth">
                                数量：
                            </td>
                            <td class="table_none table_none_NoWidth">
                                <asp:TextBox ID="tbCount" 
                                    title="数量输入格式不正确~int!" runat="server" Text="1" Enabled="False"></asp:TextBox></td></tr></table></ContentTemplate></cc2:TabPanel><cc2:TabPanel runat="server" HeaderText="其他参考信息" ID="TabPanel2">
                <ContentTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        style="border-collapse: collapse;">
                        <tr>
                        ...
                        <tr id="tr11" runat="server">
                            ...
                            <td id="Td1" runat="server" colspan="3">
                                <div id="t1" style="display: none">
                                    <img src="" id="myimg"></div></td></tr></table></ContentTemplate></cc2:TabPanel><%-- <cc2:TabPanel ID="TabPanel_Import" HeaderText="批量导入" runat="server">
            <ContentTemplate>
            ...
            </cc2:TabPanel>--%></cc2:TabContainer><table width="100%" border="0" cellspacing="1" cellpadding="3" align="center" id="PostButton"
            runat="server">
            <tr>
                <td align="center">
