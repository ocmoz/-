<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManagement_QuarterlyBudget_QuarterlyBudget, App_Web_s8acuvfe" title="无标题页" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="季度预算查阅"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加季度预算" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="MakeQuarterlyBudget.aspx?cmd=add" />
