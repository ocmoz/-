<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManagement_QuarterlyBudget_ViewQuarterlyBudget, App_Web_s8acuvfe" title="无标题页" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="季度预算查阅"
        HeadOPTxt="目前操作功能：季度预算查阅">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="季度预算列表" ButtonPopedom="List"
            ButtonUrlType="Href" ButtonUrl="QuarterlyBudget.aspx" />
