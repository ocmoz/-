<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManagement_ImplementationOfTheBudget_MakeImplementationOfTheBudget, App_Web_xotksnni" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="填写季度实际开支"
        HeadOPTxt="目前操作功能：填写季度实际开支">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="季度预算列表" ButtonPopedom="List"
            ButtonUrlType="Href" ButtonUrl="ImplementationOfTheBudget.aspx" />
            ...
            <table border="1">
                <tr align="center">
                    <td colspan="7">
                        ...
                        预算季度<input type="text" size="2" id="Month" readonly="readonly" runat="server" />
