<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManagement_QuarterlyForecast_ViewQuarterlyForecast, App_Web_7igxv9wk" title="无标题页" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="季度预测查阅"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="季度预测列表" ButtonPopedom="List"
            ButtonUrlType="Href" ButtonUrl="QuarterlyForecast.aspx" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div style="width:100%;height:665px;overflow-x:auto;overflow-y:auto;">
            <table border="1">
                <tr align="center">
                    <td colspan="7">
                        预测年份<input type="text" size="4" id="Year" readonly="readonly" runat="server" />
                        预测季度<input type="text" size="2" id="Month" readonly="readonly" runat="server" />
                        预测部门<input type="text" id="INPTitle" readonly="readonly" runat="server" />
                    </td>
                </tr>
                <tr align="center">
