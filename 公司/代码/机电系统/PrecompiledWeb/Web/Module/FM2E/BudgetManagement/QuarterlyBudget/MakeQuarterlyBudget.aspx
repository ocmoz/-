<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BudgetManagement_QuarterlyBudget_MakeQuarterlyBudget, App_Web_s8acuvfe" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="季度预算编制"
        HeadOPTxt="目前操作功能：季度预算编制">
                ...
                <tr align="center">
                    <td colspan="7">
                        预算年份:<%--<input type="text" id="Year" readonly="readonly" runat="server" />--%><asp:Label
                            ID="Year" runat="server"></asp:Label>年&nbsp;&nbsp;&nbsp; 预算季度:<%--<input type="text" id="Month" readonly="readonly" runat="server" />--%><asp:Label
                                ID="Month" runat="server"></asp:Label>季&nbsp;&nbsp;&nbsp;预算部门:<asp:Label ID="INPTitle"
