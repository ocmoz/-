<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyApply_EditArchivesDestroyApply, App_Web_ippsud6c" title="Untitled Page" %>
                    ...
                    <table id="outwarehouse" width="880px" cellpadding="0" cellspacing="0" border="1"
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="table_none table_none_NoWidth">
                                <textarea id="TextArea1" style="width: 650px; height: 50px" runat="server" title="请输入销毁缘由~100:"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth" style="height: 30px">
