<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_ArchivesManager_ArchivesBorrowApply_ArchivesBorrowApply_ViewArchivesBorrowApply, App_Web_cw5gfixl" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <div style="width: 900px; height: 500px;">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="档案借阅申请详细信息" ID="TabPanel1">
                <ContentTemplate>
