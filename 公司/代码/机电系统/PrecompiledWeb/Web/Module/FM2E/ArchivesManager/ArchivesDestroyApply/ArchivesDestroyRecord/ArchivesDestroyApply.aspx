<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyRecord_ArchivesDestroyApply, App_Web_byogsmaa" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="执行档案销毁操作"
        HeadOPTxt="目前操作功能：执行档案销毁" HeadHelpTxt="申请列表默认显示新增申请">
    ...
    <div style="width: 900px; height: 300px;">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="申请列表" ID="TabPanel1">
                    ...
                    <div style="width: 880px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:ButtonField ButtonType="Image" Text="销毁" ImageUrl="~/images/ICON/select.gif"
                                    HeaderText="销毁" CommandName="destroy"></asp:ButtonField>
                            </Columns>
                            <EmptyDataTemplate>
                                没有申请信息
                            </EmptyDataTemplate>
             ...
             <cc2:TabPanel runat="server" HeaderText="销毁历史" ID="TabPanel3">
                <ContentTemplate>
                    <div style="width: 880px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
