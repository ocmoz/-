<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_ArchivesDestroyApply_ArchivesDestroyApproval_ArchivesDestroyApplyApproval, App_Web_-ygila-f" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="档案销毁申请信息审批"
        HeadOPTxt="目前操作功能：档案销毁申请审批">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="申请列表" ButtonPopedom="List"
            ButtonUrlType="href" ButtonUrl="ArchivesDestroyApply.aspx" />
