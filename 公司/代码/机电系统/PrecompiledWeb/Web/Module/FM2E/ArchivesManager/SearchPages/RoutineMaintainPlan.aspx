<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_ArchivesManager_SearchPages_RoutineMaintainPlan, App_Web_7evcle1w" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="例行保养计划档案信息查询"
    ...
    <div style="width: 900px; height: 300px;">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="计划列表" ID="TabPanel1">
                <ContentTemplate>
                    <div style="width: 880px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PlanYear" HeaderText="计划年度"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="StartDate" HeaderText="开始执行时间" DataFormatString="{0:d}">
                                </asp:BoundField>
                                <asp:BoundField DataField="CompleteDate" HeaderText="计划结束时间" DataFormatString="{0:d}">
                                </asp:BoundField>
                                <asp:BoundField DataField="PlanType" HeaderText="计划类型"></asp:BoundField>
                                <asp:BoundField DataField="StatusString" HeaderText="计划状态"></asp:BoundField>
                                <asp:TemplateField HeaderText="查看">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/select.gif"
                                            ...
                                            Visible='<%#IsBorrowed(Convert.ToInt64(Eval("PlanID")))==true?true:false%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
            ...
            <cc2:TabPanel runat="server" HeaderText="计划查询" ID="TabPanel2">
                <ContentTemplate>
