<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_MalfunctionCheckList, App_Web_js492bxd" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    验收</HeaderTemplate>
                                <ItemTemplate>
                                  <asp:ImageButton  CommandArgument="<%# Container.DataItemIndex %>" AlternateText="验收" runat="server" ImageUrl="~/images/ICON/Approval.gif" ID="ibCheck" CommandName="check" Visible='<%#(Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.Waiting4Check)||(Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.Waiting4ReporterCheck)?true:false  %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--  
                            <asp:TemplateField>
