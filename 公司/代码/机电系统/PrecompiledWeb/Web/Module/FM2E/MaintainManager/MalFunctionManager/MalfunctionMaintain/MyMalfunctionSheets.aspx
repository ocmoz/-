<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionMaintain_MyMalfunctionSheets, App_Web_roqfceyc" %>
                ...
                <ContentTemplate>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                维修受理人：<asp:TextBox ID="tbReceiver" runat="server"></asp:TextBox>
                            </td>
                            <td>
