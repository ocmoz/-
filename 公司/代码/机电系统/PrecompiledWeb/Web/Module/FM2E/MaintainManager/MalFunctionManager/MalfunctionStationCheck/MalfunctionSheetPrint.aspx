<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageNoCheck.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionReport_MalfunctionSheetPrint, App_Web_gvpeg8z9" %>
                ...
                <ItemTemplate>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse;" >
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td class="table_body_WithoutWidth"><asp:label runat="server"  ID="Label1" ForeColor=Blue >需要计量</asp:label>
                            </td>
                        </tr>
