<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_CancelMalfunctionList, App_Web_js492bxd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="撤单申请审批" HeadOPTxt="目前操作功能：查看处理撤单申请列表">
<%--            <cc1:HeadMenuButtonItem ButtonName="故障登记历史" ButtonIcon="list.gif" ButtonUrlType="Href"
    ...
    <div style="width: 100%;">
        ...
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="故障单撤单申请列表" ID="TabPanel1">
                <ContentTemplate>
                    <table width="100%">
                    <tr>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    撤销处理</HeaderTemplate>
                                <ItemTemplate>
                                  <asp:ImageButton  CommandArgument="<%# Container.DataItemIndex %>" AlternateText="处理" runat="server" ImageUrl="~/images/ICON/Approval.gif" ID="ibCheck" CommandName="check" Visible='<%#(Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.Wait4Canceled)?true:false  %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--  
                            <asp:TemplateField>
