<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageNoCheck.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_DelayMalfunctionSheet, App_Web_js492bxd" %>
...
<td><%#Eval("ApprovalDate")%></td>
                ...
                <div id="CheckMaintainDIV" style="text-align:center; padding:15px;">
                    ...
                    &nbsp;
                    <asp:Button ID="btCheckPassApprove" runat="server" Text="提交上一级审批" CssClass="button_bak2" 
                        onclick="btCheckPassApprove_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('是否提交上一级审批？');" />
                    &nbsp;
