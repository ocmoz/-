<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_RoutineInspectConfig, App_Web_41o32qnv" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="例行检测计划信息维护"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加例行检测计划" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="EditRoutineInspectConfig.aspx?cmd=add" />
