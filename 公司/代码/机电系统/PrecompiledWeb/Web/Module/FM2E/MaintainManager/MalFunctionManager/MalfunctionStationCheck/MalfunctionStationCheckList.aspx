<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionStationCheck_MalfunctionStationCheckList, App_Web_gvpeg8z9" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="值班站长确定" HeadOPTxt="目前操作功能：值班站长确定列表">
<%--            <cc1:HeadMenuButtonItem ButtonName="故障登记历史" ButtonIcon="list.gif" ButtonUrlType="Href"
    ...
    <div style="width: 100%;">
        ...
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="故障处理单确定列表" ID="TabPanel1">
                <ContentTemplate>
                    <table width="100%">
                    <tr>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    验收</HeaderTemplate>
                                <ItemTemplate>
                                  <asp:ImageButton  CommandArgument="<%# Container.DataItemIndex %>" AlternateText="确定" runat="server" ImageUrl="~/images/ICON/Approval.gif" ID="ibCheck" CommandName="check" Visible='<%#Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.AnotherCheck?true:false  %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <%--  
                            <asp:TemplateField>
