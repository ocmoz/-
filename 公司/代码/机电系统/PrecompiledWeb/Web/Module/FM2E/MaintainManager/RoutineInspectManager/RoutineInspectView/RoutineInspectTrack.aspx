<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectView_RoutineInspectTrack, App_Web_nuqozmdy" title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                                ...
                                <td>
                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="100%">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RecordDateString" HeaderText="计划检测时间范围"></asp:BoundField>
                                            <asp:BoundField DataField="RecordDateString" HeaderText="实际检测时间"></asp:BoundField>
                                            <asp:BoundField DataField="RecordResultString" HeaderText="实际检测结果"></asp:BoundField>
                ...
                <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="例行检测执行情况">
                    <ContentTemplate>
