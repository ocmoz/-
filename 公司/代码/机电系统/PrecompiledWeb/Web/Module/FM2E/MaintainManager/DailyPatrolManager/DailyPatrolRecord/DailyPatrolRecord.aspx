<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolRecord_DailyPatrolRecord, App_Web_k_oy-zmb" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="日常巡查过程信息维护"
        HeadOPTxt="目前操作功能：实际日常巡查过程信息录入">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="我的巡查历史" ButtonUrlType="Href"
            ButtonUrl="DailyPatrolHistory.aspx" />
            ...
            <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="实际日常巡查信息">
                    <ContentTemplate>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                                ...
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3" style="height: 30px">
                                        <asp:DropDownList ID="DDLRecordObject" runat="server" title="请选择巡查项目~" OnSelectedIndexChanged="DDLRecordObjectOnSelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                        <span style="color: Red">*</span>
                                    </td>
                                    ...
                                    <cc2:CascadingDropDown ID="CascadingDropDown3" runat="server" TargetControlID="DDLRecordObject"
                                        Category="MaintainObject" PromptText="请选择巡查项目..." LoadingText="巡查项目加载中..." ServicePath="SystemSubsystemMaintainObjectService.asmx"
                                        ServiceMethod="GetDailyPatrolObject" ParentControlID="DDLSubsystem" Enabled="True">
                                    </cc2:CascadingDropDown>
                                </tr>
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3">
                                        ...
                                        <asp:GridView Width="100%" ID="GridView1" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="巡查结果" HeaderStyle-Width="20%">
                                                    <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" style="height: 30px">
                                        <asp:TextBox ID="TBRecordDate" runat="server" title="请输入巡查日期~" class="input_calender"
                                    ...
                                    <td class="table_none table_none_NoWidth" style="height: 30px">
                                       <%-- <asp:TextBox ID="TBRecordmanID" runat="server" title="请输入巡查人~"></asp:TextBox>--%>
                                       <asp:Label ID="Label_Patroler" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3" style="height: 78px">
                                        <textarea id="taRecordResult" style="width: 100%; height: 67px" runat="server" title="请输入实际巡查结果~200:"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="table_body table_body_NoWidth" style="height: 78px">
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3" style="height: 78px">
                                        <textarea id="taRemark" style="width: 100%; height: 67px" runat="server" title="请输入备注~200:"></textarea>
                                    </td>
                                </tr>
                                ...
                                <td>
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView2_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RecordObject" HeaderText="巡查项目"></asp:BoundField>
                                            <asp:BoundField DataField="RecordDate" HeaderText="巡查时间" DataFormatString="{0:yyyy-MM-dd}" HtmlEncode="false"></asp:BoundField>
                        ...
                        <center>
                          <asp:Button ID="Button2" runat="server" CssClass="button_bak" Text="提交" OnClick="Button2_Click" OnClientClick="javascript:return confirm('确认提交？');" />
                        </center>
                    </ContentTemplate>
                </cc2:TabPanel>
            </cc2:TabContainer>
