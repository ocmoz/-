<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineMaintainManager_RoutineMaintainView_RoutineMaintainTrack, App_Web_ux-0jlzx" title="Untitled Page" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                                ...
                                <td>
                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="100%">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RecordDateString" HeaderText="计划保养时间范围"></asp:BoundField>
                                            <asp:BoundField DataField="RecordDateString" HeaderText="实际保养时间"></asp:BoundField>
                                            <asp:BoundField DataField="RecordResultString" HeaderText="实际保养结果"></asp:BoundField>
                ...
                <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="例行保养执行情况">
                    <ContentTemplate>
