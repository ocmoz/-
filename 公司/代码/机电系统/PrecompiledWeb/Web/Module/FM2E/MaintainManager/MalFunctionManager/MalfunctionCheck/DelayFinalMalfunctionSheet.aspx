<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageNoCheck.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_DelayFinalMalfunctionSheet, App_Web_js492bxd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="延时单审批"
        HeadHelpTxt="帮助" HeadOPTxt="目前操作功能：延时单审批">
                ...
                <div id="CheckMaintainDIV" style="text-align:center; padding:15px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <td class="table_body table_body_NoWidth" style="height: 30px; text-align:center;">
                            ...
                            <td class="table_none table_none_NoWidth"  style="height: 30px">
                               <asp:Label ID="lbFirstApproveTime" runat="Server" Text=""></asp:Label>
                            </td>
                            <td class="table_body table_body_NoWidth" style="height: 30px; text-align:center;">
                                审批结果为：
                            </td>
                            <td class="table_none table_none_NoWidth"  style="height: 30px">
                               <asp:Label ID="lbFirstDelayApprove" runat="Server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        <td class="table_body table_body_NoWidth" style="height: 30px; text-align:center;">
                            ...
                            <td class="table_none table_none_NoWidth"  style="height: 30px">
                               <asp:Label ID="lbFirstApproveName" runat="Server" Text=""></asp:Label>
                            </td>
                            <td class="table_body table_body_NoWidth" style="height: 30px; text-align:center;">
                                审批通过的延迟时间：
                            </td>
                            <td class="table_none table_none_NoWidth"  style="height: 30px">
                               <asp:Label ID="lbFirstTime" runat="Server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth" style="height: 30px; text-align:center;">
                            ...
                            <td class="table_none table_none_NoWidth" colspan="3" style="height: 30px">
                               <asp:Label ID="lbFirstRemark"  runat="Server" Text=""></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr id="repairDiv" runat="server">
                            ...
                            <td id="Td2" class="table_none_WithoutWidth " style="height: 30px;" colspan="5" 
                                runat="server">
                                <asp:TextBox ID="TB_RepairedTime" runat="server" Columns="4"></asp:TextBox>
                    ...
                    <asp:Button ID="btCheckPass" runat="server" Text="同意" CssClass="button_bak2" 
                        onclick="btCheckPass_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('确定同意延迟？');" />
                    &nbsp;
                    <asp:Button ID="btCheckFailed" runat="server" Text="不同意" 
                        CssClass="button_bak2" onclick="btCheckFailed_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('确定不同意延迟申请？');" />
                        <asp:Button ID="btCheckPassTime" runat="server" Text="协商时间" CssClass="button_bak2" 
                        onclick="btCheckPassTime_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('确定当前协商时间？');" />
                    &nbsp;
