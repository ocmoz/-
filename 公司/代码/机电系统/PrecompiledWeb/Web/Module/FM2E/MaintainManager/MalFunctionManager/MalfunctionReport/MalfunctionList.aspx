<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionReport_MalfunctionList, App_Web_pvwh28ng" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">   
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="故障上报和确定" HeadOPTxt="目前操作功能：故障处理单列表">
        <cc1:HeadMenuButtonItem ButtonName="故障上报" ButtonIcon="new.gif" ButtonUrlType="Href"
            ButtonPopedom="New" ButtonUrl="RecordMalfunction.aspx?cmd=add" />
            ...
            <cc2:TabPanel runat="server" HeaderText="故障处理单列表" ID="TabPanel1">
                <ContentTemplate>
                    ...
                    <td style="text-align:left;">
                        <asp:DropDownList ID="SortDropDownList" runat="server" OnSelectedIndexChanged="OnFilter" AutoPostBack="true">
                            <asp:ListItem Value="UpdateTime">更新时间</asp:ListItem>
                            <asp:ListItem Value="ReportTime">上报时间</asp:ListItem>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"  AllowSorting="true" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    下一审批</HeaderTemplate>
                                <ItemTemplate>
                                  <%#Convert.ToInt32(Eval("Status")) == 32 ? Convert.ToString(Eval("NextApproverPersonName")) : null%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                  <asp:ImageButton  CommandArgument="<%# Container.DataItemIndex %>" AlternateText="确认实际修复时间" runat="server" ImageUrl="~/images/ICON/Approval.gif" ID="ibCheck" CommandName="check" 
                                  Visible='<%#Convert.ToInt32(Eval("ActualRepairTime"))==0
                                  &&Convert.ToInt32(Eval("Status"))!=(int)MalfunctionHandleStatus.Waiting4Accept
                                  &&Convert.ToInt64(Eval("DepartmentID"))==(long)WebUtility.UserData.CurrentUserData.DepartmentID?true:false  %>' OnClientClick="return confirm('是否要确认该故障单的实际修复时间？')" />
                            ...
                            <%--  
                             <asp:TemplateField>
                                <HeaderTemplate>
                                    值班站长确认</HeaderTemplate>
                                <ItemTemplate>
                                  <asp:ImageButton  CommandArgument="<%# Container.DataItemIndex %>" AlternateText="确认故障单" runat="server" ImageUrl="~/images/ICON/Approval.gif" ID="ibStationCheck" CommandName="stationcheck" Visible='<%#Convert.ToInt32(Eval("Stationcheck"))==0&&Convert.ToInt32(Eval("Status"))!=(int)MalfunctionHandleStatus.Waiting4Accept?true:false  %>' OnClientClick="return confirm('是否要确认该故障单？')" />
