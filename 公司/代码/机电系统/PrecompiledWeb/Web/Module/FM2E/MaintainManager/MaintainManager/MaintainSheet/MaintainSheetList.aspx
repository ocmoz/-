<%@ page title="维护记录" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MaintainManager_MaintainSheet_MaintainSheetList, App_Web_ltngjpvs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" Runat="Server">
  <script type="text/javascript" src="<%=Page.ResolveUrl("~/") %>inc/FineMessBox/js/common.js"></script>
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="维护记录"
        HeadOPTxt="目前操作功能：维护记录列表" HeadHelpTxt="请按照条件筛选记录">
         <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="维护登记" ButtonUrlType="Href"
            ButtonUrl="../MaintainTemplate/MaintainTemplateList.aspx" />
            ...
            <cc2:TabPanel runat="server" HeaderText="维护计划" ID="TabPanel1">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                    style="border-collapse: collapse;">
                        ...
                        <tr>
                           ...
                           <td   style="width: 25%; " class="table_body table_body_NoWidth">部门：<asp:DropDownList ID="DropDownList_Department" runat="server"></asp:DropDownList></td>
                            <td   style="width: 22%; " class="table_body table_body_NoWidth">
                            ...
                            <td   style="width: 15%; " class="table_body table_body_NoWidth">
                             ...
                             <td   style="width: 16%; "  class="table_body table_body_NoWidth">
                                 核实： <asp:DropDownList ID="DropDownList_ConfirmResult" runat="server">
                                </asp:DropDownList>
                                </td>
                        </tr>
                        <tr><td colspan="2"  class="table_body table_body_NoWidth">
                                时间： <asp:TextBox  class="input_calender"
                          ...
                          <td class="table_body table_body_NoWidth">
                                维护人： <asp:TextBox ID="TextBox_MaintainerName" runat="server"></asp:TextBox>
                            </td>
                               <td class="table_body table_body_NoWidth">
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="table_body table_body_NoWidth">地址：
                            <asp:TextBox ID="TextBox_Address" runat="server" Width="60%" onfocus="javascript:showPopWin('选择地址','../../../BasicData/AddressManage/Address.aspx?operator=select', 900, 400, addAddress,true,true);"></asp:TextBox> <input class="button_bak" onclick="javascript:Clear('Address');" type="button" value="清除地址"
                    ...
                    style="border-collapse: collapse;">
                      ...
                      <td  style="width: 10%; " class="table_body_WithoutWidth">时间</td>
                      
                      <td  style="width: 7%; " class="table_body_WithoutWidth">核实</td>
                      ...
                      <td>
                      <font color="red">
                      <%# (bool)Eval("HasAbnormal") ? "■":"" %></font></td>
                                     
                      <td><%#  Eval("MaintainerName") %></td>
                      <td><%#  Eval("MaintainTime", "{0:yyyy-MM-dd}")%></td>
                      <td><%#  EnumHelper.GetDescription((Enum)Eval("ConfirmResult")) %></td>
