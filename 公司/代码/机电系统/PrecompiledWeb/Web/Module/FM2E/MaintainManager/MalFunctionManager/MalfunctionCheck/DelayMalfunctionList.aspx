<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_DelayMalfunctionList, App_Web_js492bxd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="故障处理单延迟处理" HeadOPTxt="目前操作功能：故障处理单延迟申请列表">
<%--            <cc1:HeadMenuButtonItem ButtonName="故障登记历史" ButtonIcon="list.gif" ButtonUrlType="Href"
    ...
    <div style="width: 100%;">
        ...
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="故障处理延迟申请收列表" ID="TabPanel1">
                <ContentTemplate>
                    <table width="100%">
                    <tr>
