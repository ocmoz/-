<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionMaintain_MalfunctionSheets, App_Web_roqfceyc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="已受理的故障单"
                ...
                <ContentTemplate>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                表单状态：<asp:DropDownList ID="ddlFilterStatus" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="ReportDate" HeaderText="报修时间" HtmlEncode="False" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}">
                                <HeaderStyle Width="7%" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <%#EnumHelper.GetDescription((Enum)Eval("MalfunctionRank"))%>
                                </ItemTemplate>
                                <ItemStyle Width="5%" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    操作</HeaderTemplate>
                                <ItemTemplate>
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/ICON/record.PNG"
                                        AlternateText="登记" CommandName="record" CommandArgument="<%# Container.DataItemIndex %>"
                                        CausesValidation="false" Visible='<%#Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.Waiting4Mark||Convert.ToInt32(Eval("Status"))==(int)MalfunctionHandleStatus.ReturnModify?true:false  %>' />
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/ICON/view.GIF"
                                        AlternateText="查看" CommandName="view" CommandArgument="<%# Container.DataItemIndex %>"
                ...
                <ContentTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:DropDownList ID="ddlFilterMaintainTeam2" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
