<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageNoCheck.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionStationCheck_StationCheckMalfunctionSheet, App_Web_gvpeg8z9" %>
...
<td><%#Eval("ApprovalDate")%></td>
                ...
                <div id="CheckMaintainDIV" style="text-align:center; padding:15px;">
                    ...
                    <asp:Button ID="btCheckPass" runat="server" Text="通过" CssClass="button_bak2" 
