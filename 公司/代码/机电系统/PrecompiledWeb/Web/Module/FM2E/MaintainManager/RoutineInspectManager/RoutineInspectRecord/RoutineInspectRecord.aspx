<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectRecord_RoutineInspectRecord, App_Web_azhczbtl" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="例行检测过程信息维护"
        HeadOPTxt="目前操作功能：实际例行检测过程信息录入">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                <cc2:TabPanel ID="TabPanel1" runat="server" HeaderText="实际例行检测信息">
                    <ContentTemplate>
                            ...
                            <table width="880px" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                                ...
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3" style="height: 30px">
                                        <asp:DropDownList ID="DDLRecordObject" runat="server" title="请选择检测项目~" OnSelectedIndexChanged="DDLRecordObjectOnSelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                        <span style="color: Red">*</span>
                                    </td>
                                    ...
                                    <cc2:CascadingDropDown ID="CascadingDropDown3" runat="server" TargetControlID="DDLRecordObject"
                                        Category="MaintainObject" PromptText="请选择检测项目..." LoadingText="检测项目加载中..." ServicePath="SystemSubsystemMaintainObjectService.asmx"
                                        ServiceMethod="GetRoutineInspectObject" ParentControlID="DDLSubsystem" Enabled="True">
                                    </cc2:CascadingDropDown>
                                </tr>
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3">
                                        ...
                                        <asp:GridView Width="100%" ID="GridView1" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="检测结果" HeaderStyle-Width="20%">
                                                    <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" style="height: 30px">
                                        <asp:TextBox ID="TBRecordDate" runat="server" title="请输入检测日期~" class="input_calender"
                                    ...
                                    <td class="table_none table_none_NoWidth" style="height: 30px">
                                        <asp:TextBox ID="TBRecordmanID" runat="server" title="请输入检测人~"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="table_none table_none_NoWidth" colspan="3" style="height: 78px">
                                        <textarea id="taRecordResult" style="width: 650px; height: 67px" runat="server" title="请输入实际检测结果~200:"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="table_body table_body_NoWidth" style="height: 78px">
                                ...
                                <td>
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView2_RowCommand"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="RecordObject" HeaderText="检测项目"></asp:BoundField>
                                            <asp:BoundField DataField="RecordDate" HeaderText="检测时间"></asp:BoundField>
                                            <asp:BoundField DataField="RecordmanName" HeaderText="检测人"></asp:BoundField>
