<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolConfig_ViewDailyPatrolConfig, App_Web_xcnx-3_u" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <div style="width: 900px;">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="日常巡查计划明细信息" ID="TabPanel1">
                <ContentTemplate>
