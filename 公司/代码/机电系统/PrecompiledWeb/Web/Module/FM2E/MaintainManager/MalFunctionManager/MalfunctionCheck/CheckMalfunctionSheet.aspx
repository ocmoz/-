<%@ page title="" language="C#" masterpagefile="~/MasterPage/MasterPageNoCheck.master" autoeventwireup="true" inherits="Module_FM2E_MaintainManager_MalFunctionManager_MalfunctionCheck_CheckMalfunctionSheet, App_Web_js492bxd" %>
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" colspan="3" style="height: 30px">
                                <asp:TextBox ID="tbCheckInfor" runat="server" MaxLength="200" Width="95%" TextMode="MultiLine"
                                    Rows="3" title="请输入验收说明~200:!"></asp:TextBox>
                                <span style="color: Red">*</span>
                            </td>
                        </tr>
                    </table>
                
                    <asp:Button ID="btCheckPass" runat="server" Text="验收通过" CssClass="button_bak2" 
                        onclick="btCheckPass_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('确定验收通过？');" />
                    &nbsp;
                    <asp:Button ID="btCheckFailed" runat="server" Text="不通过并返回修复" 
                        CssClass="button_bak2" onclick="btCheckFailed_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('确定验收不通过并返回修复？');" />
                        &nbsp;
                        <asp:Button ID="btNotice" runat="server" Text="通知故障所在部门验收" 
                        CssClass="button_bak2" onclick="btNotice_Click" OnClientClick="javascript:return checkForm(document.forms[0],true)&& confirm('是否通知故障所在部门进行验收？');" />
                </div>
