<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolView_DailyPatrolConfig, App_Web_jvjeflbq" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="日常巡查计划信息维护"
        HeadOPTxt="目前操作功能：日常巡查计划信息维护" HeadHelpTxt="日常巡查计划列表默认显示新添日常巡查计划">
    ...
    <div style="width: 900px; ">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" colspan="3" style="height: 30px">
                                <asp:DropDownList ID="DDLPlanObject" runat="server" title="请选择巡查项目~">
                                </asp:DropDownList>
                                <span style="color: Red">*</span>
                            </td>
            ...
            <cc2:TabPanel runat="server" HeaderText="日常巡查计划列表" ID="TabPanel1">
                <ContentTemplate>
                    <div style="width: 880px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PlanObject" HeaderText="巡查项目"></asp:BoundField>
                                <asp:BoundField DataField="PlanPeriodString" HeaderText="巡查周期"></asp:BoundField>
