<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_SelectDevice, App_Web_41o32qnv" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="设备配置管理"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="move.gif" ButtonName="计划列表" ButtonPopedom="List"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="RoutineInspectConfig.aspx" />
