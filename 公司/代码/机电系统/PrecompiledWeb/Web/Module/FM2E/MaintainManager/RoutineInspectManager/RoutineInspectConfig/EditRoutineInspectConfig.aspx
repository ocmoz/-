<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_RoutineInspectManager_RoutineInspectConfig_EditRoutineInspectConfig, App_Web_41o32qnv" title="无标题页" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="例行检测计划信息维护"
        HeadOPTxt="目前操作功能：例行检测计划维护">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="计划列表" ButtonPopedom="List"
            ButtonUrlType="href" ButtonUrl="RoutineInspectConfig.aspx" />
                ...
                <ContentTemplate>
                    <table width="880px" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:TextBox ID="TBPlanObject" runat="server" title="请输入检测对象~50:!"></asp:TextBox><span
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" colspan="3" style="height: 78px">
                                <textarea id="TextArea2" style="width: 723px; height: 67px" runat="server" title="请输入检测内容~200:"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth" style="height: 78px">
