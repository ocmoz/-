<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" enableeventvalidation="false" inherits="Module_FM2E_MaintainManager_DailyPatrolManager_DailyPatrolConfig_DailyPatrolConfig, App_Web_xcnx-3_u" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="日常巡查计划信息维护"
        ...
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加日常巡查计划" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="EditDailyPatrolConfig.aspx?cmd=add" />
