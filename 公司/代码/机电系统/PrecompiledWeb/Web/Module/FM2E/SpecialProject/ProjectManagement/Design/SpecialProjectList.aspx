<%@ page title="专项工程列表" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectManagement_Design_SpecialProjectList, App_Web_k_yhflah" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--施工管理"
        HeadOPTxt="目前操作功能：工程设计" HeadHelpTxt="当前需要进行设计工作的工程列表">
                ...
                <td>
                    <asp:GridView ID="gridview_ProjectList" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="设计" ShowHeader="False">
                                <ItemTemplate>
                                    <a href='<%# "ViewProject.aspx?cmd=edit&projectid=" + Eval("ProjectID") %>'>
