<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectApproval_CostOffice_ViewProject, App_Web_4kfxef5l" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程审批"
        HeadOPTxt="目前操作功能：造价厅管理站设计预算审查" HeadHelpTxt="点击“同意”快速输入“详细意见”">
