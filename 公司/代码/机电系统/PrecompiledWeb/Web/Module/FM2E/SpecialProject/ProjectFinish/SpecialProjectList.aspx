<%@ page title="专项工程列表" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectFinish_SpecialProjectList, App_Web_m43y3lca" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程验收"
        HeadOPTxt="目前操作功能：工程验收" HeadHelpTxt="当前需要进行工程验收工作的工程列表">
                    ...
                    <asp:GridView ID="gridview_ProjectList" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="验收" ShowHeader="False">
                                <ItemTemplate>
                                    <a href='<%# "CheckAccept.aspx?cmd=approval&projectid=" + Eval("ProjectID") %>'>
