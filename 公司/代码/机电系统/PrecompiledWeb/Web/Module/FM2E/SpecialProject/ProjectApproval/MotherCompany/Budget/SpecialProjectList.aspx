<%@ page title="专项工程列表" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectApproval_MotherCompany_Budget_SpecialProjectList, App_Web_wndtyfbi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程审批"
        HeadOPTxt="目前操作功能：路桥公司预算批复" HeadHelpTxt="当前需要路桥公司进行预算批复工作的工程列表">
