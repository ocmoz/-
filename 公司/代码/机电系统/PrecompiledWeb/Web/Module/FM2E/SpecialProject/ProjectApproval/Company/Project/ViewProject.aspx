<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectApproval_Company_Project_ViewProject, App_Web_wcirtqvm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function check() {
            var f = trim(document.getElementById('<%= TextBox_FeeBack.ClientID %>').value);
            ...
            return cfm = confirm('确认审批？审批后不能修改');

        }

        function setAgree() {
            document.getElementById('<%= TextBox_FeeBack.ClientID %>').value += " 同意 ";
        }
    </script>
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程审批"
        HeadOPTxt="目前操作功能：公司主管部门立项审批" HeadHelpTxt="点击“同意”快速输入“详细意见”">
    </cc1:HeadMenuWebControls>
    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%">
        <cc2:TabPanel runat="server" HeaderText="审批以及审批历史" ID="TabPanel10">
            <ContentTemplate>
                <table id="Table5" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <a href="javascript:setAgree();" style="color: Blue">同意</a><br />
                            <asp:TextBox ID="TextBox_FeeBack" runat="server" TextMode="MultiLine" Width="95%"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:FileUpload ID="FileUpload_ApprovalFile" runat="server"></asp:FileUpload><br />
                            <asp:HyperLink ID="HyperLink1" ForeColor="Blue" Font-Underline="True" runat="server"
                                Visible="False"></asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
                        <td class="Table_searchtitle" colspan="4">
                            <asp:Button ID="Button_Approval" runat="server" Text="审批" class="button_bak" OnClick="Button_Approval_Click"
                ...
                <table id="Table6" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr id="tr1" runat="server">
                        <td class="Table_searchtitle" runat="server">
                            审批历史记录
                        </td>
                    </tr>
                    <tr id="tr2" runat="server">
                        <td runat="server">
                            <asp:GridView ID="gridview_ApprovalList" runat="server" AutoGenerateColumns="False"
