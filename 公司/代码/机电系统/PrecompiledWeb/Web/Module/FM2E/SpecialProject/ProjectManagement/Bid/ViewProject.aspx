<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectManagement_Bid_ViewProject, App_Web_e-btwkdn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--施工管理"
        HeadOPTxt="目前操作功能：工程招标信息查看" HeadHelpTxt="点击提交可以进入审批流程">
    </cc1:HeadMenuWebControls>
    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" 
        Width="100%">
        ...
        <cc2:TabPanel runat="server" HeaderText="招标信息" ID="TabPanel5">
            <ContentTemplate>
                <table id="Table_Bid" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr>
                        <td colspan="4" style="text-align:center">
                            <asp:Button runat="server" Text="进行招标" CssClass="button_bak" ID="Button_BidEdit" OnClick="Button_BidEdit_Click">
</asp:Button>
<asp:Button runat="server" Text="提交审批" CssClass="button_bak" ID="Button_BidSubmit" OnClick="Button_BidSubmit_Click" OnClientClick="javascript:return confirm('确认提交?');">
</asp:Button>
