<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectApply_ViewProject, App_Web_i4s4q9u5" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function check() {
            ...
            return cfm = confirm('确认立项？提交后不能修改');
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程立项"
        HeadOPTxt="目前操作功能：查看专项工程信息" HeadHelpTxt="切换不同的选项卡查看">
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回" ButtonPopedom="List" ButtonUrl="javascript:history.go(-1);"
         ButtonUrlType="JavaScript" />
    </cc1:HeadMenuWebControls>
    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" 
        Width="100%">
        <cc2:TabPanel runat="server" HeaderText="审批历史" ID="TabPanel10">
            <ContentTemplate>
                <table id="Table5" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr>
                        <td class="Table_searchtitle" colspan="4">
                            <asp:Button ID="Button_Approval" runat="server" Text="提交" class="button_bak" 
