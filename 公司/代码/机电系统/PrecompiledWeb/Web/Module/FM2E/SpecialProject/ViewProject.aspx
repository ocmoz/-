<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ViewProject, App_Web_smgkwgbp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理"
        HeadOPTxt="目前操作功能：查看专项工程信息" HeadHelpTxt="请根据选项卡查看各方面信息">
        <cc1:HeadMenuButtonItem ButtonIcon="back.gif" ButtonName="返回" ButtonPopedom="List"
            ButtonUrl="javascript:history.go(-1);" ButtonUrlType="JavaScript" />
    ...
    <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                ...
                <table id="Table6" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr id="tr2" runat="server">
                        <td id="Td2" runat="server">
                            <asp:GridView ID="gridview_ApprovalList" OnRowDataBound="GridView1_RowDataBound" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="附件">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" ForeColor="Blue" Font-Underline="True"
        ...
        <cc2:TabPanel ID="TabPanel_Flow" runat="server" HeaderText="审批流程">
            <ContentTemplate>
                <center>
                    <font size="6"><b>专项工程审批流程</b></font></center>
                <hr />
                <p>
                    50万以下：</p>
                <p>
                    <img src="../../../public/SpecialProjectPic/50.GIF" />
                </p>
                <hr />
                <p>
                    50~500万：</p>
                <p>
                    <img src="../../../public/SpecialProjectPic/500.GIF" />
                </p>
                <hr />
                <p>
                    500万以上：</p>
                <p>
                    <img src="../../../public/SpecialProjectPic/500+.GIF" /></p>
            </ContentTemplate>
        </cc2:TabPanel>
    </cc2:TabContainer>
</asp:Content>
