<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectManagement_Design_ViewProject, App_Web_k_yhflah" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--施工管理"
        HeadOPTxt="目前操作功能：工程设计方案信息查看" HeadHelpTxt="点击提交可以进入设计审批">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td colspan="4" style="text-align:center">
                           <asp:Button ID="Button_DesignEdit" runat="server"  Text="进行设计"  CssClass="button_bak"
                                onclick="Button_DesignEdit_Click"/>
                           <asp:Button ID="Button_DesignSubmit" runat="server"  Text="提交方案" CssClass="button_bak"
                                onclick="Button_DesignSubmit_Click" OnClientClick="javascript:return confirm('确认提交？');"/>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
