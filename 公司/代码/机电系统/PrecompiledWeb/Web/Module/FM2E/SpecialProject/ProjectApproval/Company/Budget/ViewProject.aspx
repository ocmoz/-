<%@ page title="查看专项工程" language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_SpecialProject_ProjectApproval_Company_Budget_ViewProject, App_Web_ejulcfjj" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="专项工程管理--工程审批"
        HeadOPTxt="目前操作功能：公司主管部门预算审查" HeadHelpTxt="点击“同意”快速输入“详细意见”">
        ...
        <cc2:TabPanel runat="server" HeaderText="审批以及审批历史" ID="TabPanel10">
            <ContentTemplate>
                <table id="Table5" style="width: 100%; border-collapse: collapse; vertical-align: middle;
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                         <a href="javascript:setAgree();" style="color:Blue">同意</a><br />
                            <asp:TextBox ID="TextBox_FeeBack" runat="server" TextMode="MultiLine" Width="95%" Height="70px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="Table_searchtitle">
                    ...
                    <tr>
                        <td class="Table_searchtitle" colspan="4">
                            <asp:Button ID="Button_Approval" runat="server" Text="审批" class="button_bak" 
                                onclick="Button_Approval_Click" OnClientClick="javascript:return check();" />
                        </td>
                    </tr>
                </table>
                <br />
