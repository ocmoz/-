<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_Plan_ScheduleActual, App_Web_rpkbay2n" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="月度用款明细"
        HeadHelpTxt="帮助" HeadOPTxt="目前操作功能：月度用款明细">
                ...
                <table  width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc" style="border-collapse: collapse;
                    ...
                    <tr>
                        <td colspan="5" class="table_body_WithoutWidth">
                            <b style="font-family: 宋体; font-size: medium">深圳高速公路股份有限公司 项目月度实际用款明细表</b>
                        </td>
                    </tr>
                    <tr>
