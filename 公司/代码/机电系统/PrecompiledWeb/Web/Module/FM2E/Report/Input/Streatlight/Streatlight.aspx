<%@ page language="C#" autoeventwireup="true" inherits="Module_FM2E_Report_Input_Streatlight, App_Web_-p6kpthy" %>
					...
					<ul>
						<li>
							<input type="button" id="b1" runat="server"
							    onclick="javascript:jump('Ludeng_LudengSuidao_i.raq','')"
								value="路灯隧道所信息月报" style="height: 29px; text-align: center; width: 170px;cursor: hand;"/>
						</li>
						<li>
