<%@ page language="C#" autoeventwireup="true" inherits="Module_FM2E_Report_Input_Electromechanics, App_Web_miodbwv1" %>
					...
					<%-- 
						...
						<li>
							<input type="button" id="b3" runat="server"
								onclick="javascript:jump('Jidian_Ruodian_SystemBasicData_i.raq','a')"
