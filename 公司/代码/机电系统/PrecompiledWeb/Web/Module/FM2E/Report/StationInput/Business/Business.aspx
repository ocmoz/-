<%@ page language="C#" autoeventwireup="true" inherits="Module_FM2E_Report_Input_Business, App_Web_cuj3rmjo" %>
            ...
            <div id="button-bar">
                <ul runat="server">
                    ...
                    <li runat="server" id="li1">
                        <input type="button" id="button1" runat="server" onclick="jump('Jingying_stationinformation_i.raq','a')"
                            value="收费站管理人员编制信息月报" style="font-family: 微软雅黑; height: 29px; text-align: center;
                            width: 210px; cursor: hand;" />
                    </li>
                    <!--
						<br />
						<br />
