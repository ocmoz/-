<%@ page language="C#" autoeventwireup="true" inherits="Module_FM2E_Report_Output_Customer, App_Web_9ww0xtat" %>
		...
		<div id="main">
			...
			<div id="main-tablist">
				<div id="button-bar">
					<ul>
						<li>
							<input type="button"  style="font-family: 微软雅黑;height: 29px; text-align: center;color:Gray; width: 168px;cursor: hand;"
