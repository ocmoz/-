<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BasicData_TollGateManage_EditTollGate, App_Web_iznbbmgz" enableeventvalidation="false" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="收费站信息维护"
        HeadOPTxt="目前操作功能：收费站信息维护">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="收费站列表" ButtonPopedom="List"
            ButtonUrlType="href" ButtonUrl="TollGate.aspx" />
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:TextBox ID="TextBox1" runat="server" title="请输入收费站编号~2:!" MaxLength="2"></asp:TextBox><span style="color:Red">*</span>
                            </td>
                            <td class="table_body table_body_NoWidth" style="height: 30px; width: 15%;">
                                收费站名称：
                            </td>
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:TextBox ID="TextBox2" runat="server" title="请输入收费站名称~20:!" MaxLength="20"></asp:TextBox><span style="color:Red">*</span>
                            </td>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth" style="height: 30px">
                            ...
                            <cc2:CascadingDropDown ID="CascadingDropDown1" runat="server" TargetControlID="DropDownList1"
                                        Category="Company" PromptText="请选择公司..." LoadingText="公司加载中..." ServicePath="CompanyServiceForTollGate.asmx"
                                    ...
                                    <cc2:CascadingDropDown ID="CascadingDropDown2" runat="server" TargetControlID="DropDownList2"
                                        Category="Section" PromptText="请选择路段..." LoadingText="路段加载中..." ServicePath="CompanyServiceForTollGate.asmx"
                                        ServiceMethod="GetSection" ParentControlID="DropDownList1">
                            </cc2:CascadingDropDown>
                        </tr>
                        <tr>
                            <td class="table_body table_body_NoWidth" style="height: 30px">
                            ...
                            <td class="table_none table_none_NoWidth" style="height: 30px">
                                <asp:TextBox ID="TextBox5" runat="server" title="请输入收费站启用时间~20:" class="input_calender"
