<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BasicData_ContractorManage_EditContractor, App_Web_rzvuuc8e" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="承包商信息维护">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="承包商列表" ButtonPopedom="List"
            ButtonUrlType="href" ButtonUrl="Contractor.aspx" />
                ...
                <ContentTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth">
                                <asp:TextBox ID="TextBox8" runat="server" title="请输入负责人电话~20:noChinese!" MaxLength="20"></asp:TextBox></asp:TextBox><span style="color:Red">*</span>
                            </td>
                            <td class="table_body table_body_NoWidth">
                            </td>
                            <td class="table_none table_none_NoWidth">
