<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BasicData_SupplierManage_Supplier, App_Web_p4htj2zu" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="供应商信息维护"
        HeadOPTxt="目前操作功能：供应商信息维护" HeadHelpTxt="供应商列表默认显示新添供应商">
        <cc1:HeadMenuButtonItem ButtonIcon="new.gif" ButtonName="添加供应商" ButtonPopedom="New"
            ButtonVisible="true" ButtonUrlType="href" ButtonUrl="EditSupplier.aspx?cmd=add" />
        <%--    <cc1:HeadMenuButtonItem ButtonIcon="move.gif" ButtonName="导入供应商信息" ButtonPopedom="New" ButtonVisible="true" ButtonUrlType="href" ButtonUrl="Import.aspx"/>
    ...
    <div style="width: 900px; ">
        <cc2:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
            <cc2:TabPanel runat="server" HeaderText="供应商列表" ID="TabPanel1">
                <ContentTemplate>
                    <div style="width: 880px; text-align: center; vertical-align: top; padding: 0px 0px 0px 0px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" Width="100%"
                            ...
                            <Columns>
                                <asp:BoundField DataField="SupplierID" HeaderText="供应商号"></asp:BoundField>
            ...
            <cc2:TabPanel ID="TabPanel2" runat="server" HeaderText="供应商查询">
                <ContentTemplate>
