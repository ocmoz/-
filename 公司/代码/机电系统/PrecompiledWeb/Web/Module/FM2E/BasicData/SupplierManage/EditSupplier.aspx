<%@ page language="C#" masterpagefile="~/MasterPage/MasterPage.master" autoeventwireup="true" inherits="Module_FM2E_BasicData_SupplierManage_EditSupplier, App_Web_p4htj2zu" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="Server">
    ...
    <cc1:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadTitleTxt="供应商信息维护">
        <cc1:HeadMenuButtonItem ButtonIcon="list.gif" ButtonName="供应商列表" ButtonPopedom="List"
            ButtonUrlType="href" ButtonUrl="Supplier.aspx" />
                ...
                <ContentTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" border="1" bordercolor="#cccccc"
                        ...
                        <tr>
                            ...
                            <td class="table_none table_none_NoWidth">
                                <asp:TextBox ID="TextBox6" runat="server" title="请输入主页~100:noChinese"></asp:TextBox>
                            </td>
                            <td class="table_body table_body_NoWidth">
                                负责人：
                            </td>
