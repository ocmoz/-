<%@ page language="C#" autoeventwireup="true" inherits="Messages, App_Web_fublbnad" %>
    ...
    <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td background="images/MessageIcon/MessageBody.gif"><table width="100%" style="table-layout:fixed;"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="6%">&nbsp;</td>
            <td width="11%" height="120"><img src="images/MessageIcon/<%# Get_M_IconType((WebUtility.Components.Icon_Type)Eval("M_IconType"))%>"></td>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td align="left"><%# Get_M_ButtonList((System.Collections.Generic.List<WebUtility.Components.sys_NavigationUrl>)Eval("M_ButtonList"))%>
            </td>
            <td>&nbsp;</td>
          </tr>
        </table></td>
