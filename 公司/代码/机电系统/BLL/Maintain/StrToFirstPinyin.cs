...
namespace FM2E.BLL.Maintain
{
    ...
    public class StrToFirstPinyin
    {
        public StrToFirstPinyin()
        { }
        private static string[] strChineseCharList = 
            { 
#region
//该字库将  涌（yong）  字的首字母归为   chong  的C
                ...
                "C瘁粹翠膵膬竁襊臎邨村皴澊竴存刌忖寸籿搓瑳遳磋撮蹉醝髊虘嵯嵳痤矬蒫鹾鹺齹脞剉剒厝夎挫莝莡措逪棤锉蓌错銼刂刹畜曾膪澶骣粢涌"   , 
                ...
                "Y郺镛臃癕雝鏞鳙廱灉饔鱅鷛癰喁颙顒鰫永甬咏怺泳俑勇勈栐埇悀柡恿傛惥愑湧硧詠塎嵱彮愹蛹慂踊禜鲬踴鯒用苚砽醟优忧攸呦怮泑幽悠麀滺憂優鄾嚘懮瀀櫌纋耰尢尤由沋犹邮怞油肬怣"   , 
