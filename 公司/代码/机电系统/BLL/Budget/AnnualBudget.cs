...
namespace FM2E.BLL.Budget
{
    public class AnnualBudget
    {
        ...
        {
            IAnnualBudget dal = FM2E.DALFactory.BudgetAccess.CreateAnnualBudget();
            return dal.SelectMaxBudgetYearRecord();
        }
        ...
        {
            IAnnualBudget dal = FM2E.DALFactory.BudgetAccess.CreateAnnualBudget();
            dal.SaveCurrentSubject(Year,ref ht);
        }
        public void UpdateCurrentSubject(long Year)
        {
            IAnnualBudget dal = FM2E.DALFactory.BudgetAccess.CreateAnnualBudget();
            dal.UpdateCurrentSubject(Year);
        }
    }
}
