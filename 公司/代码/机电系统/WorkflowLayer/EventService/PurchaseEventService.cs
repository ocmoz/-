...
{
    public class PurchaseEventService : IPurchaseEventService, IBasicEventService
    {
        ...
        public event EventHandler<ExternalDataEventArgs> ToArchinveFailed
        {
            add
            {
                if(_eventList.ContainsValue(value) == false)
                    _eventList.Add("ToArchinveFailed", value);
            }
            remove
            {
            }
